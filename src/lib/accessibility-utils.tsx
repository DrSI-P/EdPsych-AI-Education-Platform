        ...
        <div className="accessibility-panel" role="dialogue" aria-label="Accessibility settings">
          ...
          <div className="setting-group">
            <label htmlFor="high-contrast">
              <input
                ...
                onChange={(e: any) => setHighContrast(e.target.checked)}
              />
              High Contrast
            </label>
          </div>
          ...
          <div className="setting-group">
            <label htmlFor="dyslexic-font">
              <input
                ...
                onChange={(e: any) => setDyslexicFont(e.target.checked)}
              />
          ...
          <div className="setting-group">
            <label htmlFor="reduce-motion">
              <input
                ...
                onChange={(e: any) => setReduceMotion(e.target.checked)}
              />
              Reduce Motion
            </label>
          </div>
          ...
          <div className="setting-group">
            ...
            <select
              ...
              onChange={(e: any) => setColorBlindMode(e.target.value)}
            >
          ...
          <div className="setting-group">
            <label htmlFor="focus-mode">
              <input
                ...
                type="checkbox"
                checked={focusMode}
                onChange={(e: any) => setFocusMode(e.target.checked)}
              />
              Focus Mode
            </label>
          </div>
 ...
 */
export const useFocusTrap = (options = {}): void => {
