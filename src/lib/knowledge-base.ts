...
export class DrScottKnowledgeBase {
    ...
    const entries: KnowledgeEntry[] = [
      ...
      // PROFESSIONAL CREDENTIALS AND BACKGROUND
      {
        ...
        content: {
          ...
          professional: "My credentials include qualification as a Chartered Child and Adolescent Educational Psychologist with HCPC registration (PYL042340). I have over 20 years of experience in education and 12+ years of specialized practice in Educational Psychology. My doctoral research focuses on Restorative Justice in educational settings. I maintain continuing professional development requirements and adhere to strict ethical guidelines as required by my professional registration."
        },
      ...
      // INTERVENTIONS
      {
        ...
        userRoles: ['student', 'teacher', 'parent', 'professional'],
        content: {
          general: "Evidence-based interventions are the cornerstone of effective educational psychology practice. I can guide you through selecting, implementing, and monitoring interventions that are proven to work for specific learning and behavioural needs.",
      ...
      // SPECIAL EDUCATIONAL NEEDS
      {
        ...
        content: {
          ...
          teacher: "Creating inclusive classrooms benefits all students. Use Universal Design for Learning principles, provide multiple means of representation, engagement, and expression. Collaborate with specialists, implement IEP/504 accommodations, and focus on each student's strengths whilst addressing their needs.",
  ...
  private getDefaultResponse(userRole: string): string {
    ...
    return defaultResponses[userRole as keyof typeof defaultResponses] 
      || "That's a great question! As an Educational Psychologist, I can help you with assessments, interventions, learning strategies, behavioural support, and restorative justice practices. Could you tell me more about what specific area you'd like to explore?";
  }
  ...
  private getFollowUpSuggestions(category: string, userRole: string): string {
    const suggestions = {
      restorative_justice: {
        ...
        professional: "\n\nI can also discuss research findings or help with programme implementation planning.",
