...
export class CulturalContextService {
  ...
  private loadDefaultCulturalContext(): void {
    ...
    this.culturalContextCache.set(SupportedLanguage.POLISH, {
      ...
      educationalSystemNotes: 'The Polish education system has a different mark structure and academic year timing than the UK system, which may cause transition challenges.',
