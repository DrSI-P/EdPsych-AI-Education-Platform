...
export const mathematicsKS2Content: CurriculumContent[] = [
  // Number - Place Value
  {
    metadata: {
      ...
      description: 'Learn to recognize the place value of each digit in a four-digit number (thousands, hundreds, tens, and ones).',
...
3. Place the correct number of blocks in each column:
   ...
   - 4 ten blocks
   - 2 one blocks
4. Say the number aloud whilst pointing to each group of blocks
...
When adding larger numbers, we use the column method to keep our work organised.
