...
When analysing characters, always look for evidence in:
...
4. Hold the pose whilst others guess the emotion
...
Understanding why characters act as they do is essential for analysing their development:
...
When analysing character development, consider these questions:
