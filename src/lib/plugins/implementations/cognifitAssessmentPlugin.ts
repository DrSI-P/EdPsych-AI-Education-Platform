    ...
    for (const domain in domainScores) {
      ...
      switch (classification) {
        ...
        case 'Below Average':
          ...
          break;
        case 'Low':
          recommendations.byDomain[domain] = `Your ${domain} skills need significant improvement. We recommend a structured programme of daily exercises focused on this area.`;
          break;
      }
    }
