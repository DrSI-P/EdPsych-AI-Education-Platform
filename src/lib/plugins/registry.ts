        ...
        try {
          ...
          const plugin: BasePlugin = {
            getMetadata: () => ({
              ...
              supportedFeatures: dbPlugin.supportedFeatures as string: any: any: any[],
              requiredPermissions: dbPlugin.requiredPermissions as string: any: any: any[],
          ...
          const instance: PluginInstance = {
            metadata: {
              ...
              website: dbPlugin.website,
              icon: dbPlugin.icon,
              tags: dbPlugin.tags as string: any: any: any[],
              supportedFeatures: dbPlugin.supportedFeatures as string: any: any: any[],
              requiredPermissions: dbPlugin.requiredPermissions as string: any: any: any[],
              settings: dbPlugin.settings as Record<string, any>,
              compatibilityVersion: dbPlugin.compatibilityVersion,
