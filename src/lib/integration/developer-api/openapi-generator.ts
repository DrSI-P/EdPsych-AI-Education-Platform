...
export class OpenApiGenerator {
   ...
   */
  public generateOpenApiSpec(version: ApiVersion, info?: Partial<OpenApiInfo>): unknown {
  ...
  private generatePaths(version: ApiVersion): unknown {
    const paths: unknown = {};
  ...
  private generateComponents(): unknown {
    return {
      schemas: {
        ApiKey: {
          type: 'object',
