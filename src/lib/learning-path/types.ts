...
// Enhanced KeyStage namespace for enum-like access whilst preserving the original type
...
// Enhanced Subject namespace for enum-like access whilst preserving the original type
