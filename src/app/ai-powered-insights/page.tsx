...
function AIPoweredInsightsPage() {
  ...
  const insightCategories = [
    ...
    { id: 'behavior', name: 'Behavioural Insights', icon: Users, count: 5 },
  ...
  const learningInsights = [
    ...
    },
    {
      ...
      date: 'May 28, 2025',
      recommendations: [
        'Provide targeted practice with multi-step equations',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Leverage advanced AI algorithms to uncover meaningful patterns in learning, behavior, and performance data.
          </p>
        </div>
