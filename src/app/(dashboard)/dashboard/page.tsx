    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            <div className="p-3 border rounded-md hover:bg-gray-50">
              ...
              <div className="text-sm text-gray-500">Added: 1 day ago</div>
            </div>
            <div className="p-3 border rounded-md hover:bg-gray-50">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 border rounded-md hover:bg-gray-50">
              ...
              <div className="text-sm text-gray-500">Due: 3 days</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            <div className="p-3 border rounded-md hover:bg-gray-50 border-blue-100 bg-blue-50">
              <div className="font-medium">Reading Comprehension Practice</div>
              <div className="text-sm text-gray-600">Based on recent assessment results</div>
            </div>
            <div className="p-3 border rounded-md hover:bg-gray-50 border-blue-100 bg-blue-50">
              <div className="font-medium">Fractions Interactive Tutorial</div>
              <div className="text-sm text-gray-600">Recommended for your learning style</div>
            </div>
          </div>
        </div>
