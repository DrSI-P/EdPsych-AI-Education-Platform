...
export default function AssessmentTemplatesPage() {
  ...
  useEffect(() => {
    const fetchTemplates = async () => {
      try {
        const response = await fetch('/api/assessment/templates', { cache: "no-store" });
        ...
        setError('An error occurred whilst fetching the assessment templates');
      } finally {
        setLoading(false);
      }
    };
...
// Removed invalid standalone statement: AssessmentTemplatesPage