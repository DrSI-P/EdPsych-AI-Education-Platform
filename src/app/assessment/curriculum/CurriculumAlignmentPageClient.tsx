...
export default function CurriculumAlignmentPage() {
  ...
  useEffect(() => {
    const fetchCurriculumStandards = async () => {
      try {
        const response = await fetch('/api/curriculum/standards', { cache: "no-store" });
        ...
        setError('An error occurred whilst fetching the curriculum standards');
      } finally {
        setLoading(false);
      }
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
              ...
              <div>
                <select
                  ...
                  onChange={(e: any) => setSelectedKeyStage(e.target.value)}
                >
...
// Removed invalid standalone statement: CurriculumAlignmentPage