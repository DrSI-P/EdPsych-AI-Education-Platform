  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/assessment/pupil-voice/${surveyId}/submit`, {
        ...
        body: JSON.stringify({ responses }, { cache: "no-store" }),
      });
      ...
      setError('An error occurred whilst submitting your responses');
      setSubmitting(false);
    }
  };
                ...
                {currentQuestion.type === 'open_ended' && (
                  <div className="mt-3">
                    <textarea
                      ...
                      onChange={(e: any) => handleInputChange(currentQuestion.id, e.target.value)}
                    />
                  </div>
                )}
...
// Removed invalid standalone statement: TakePupilVoiceSurveyPage