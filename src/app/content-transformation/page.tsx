...
const ContentTransformationEngine = dynamic(
  () => import('@/components/ai/content-transformation/content-transformation-engine')
);

function ContentTransformationPage() {
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p>
                    The Content Transformation Engine uses advanced AI to analyze educational content and create optimised versions for each learning style. 
                    It maintains the educational objectives and factual accuracy whilst adapting the presentation format, examples, and activities to match different learning preferences.
                  </p>
                  <p className="mt-2">
                ...
                <div>
                  ...
                  <p>
                    ...
                    Whilst maintaining a critical perspective on learning style theories, the system focuses on providing 
...
export default ContentTransformationPage;