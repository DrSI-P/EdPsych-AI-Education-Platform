...
function SpeechRecognitionClient() {
  ...
  const processCommand = (command: string) => {
    ...
    // Educator-specific commands
      ...
      setTimeout(() => {
        window.location.href = '/educator/data-visualization';
      }, 1500);
    }
  ...
  const educatorCommands = [
    ...
    { command: "Timetable message to parents", action: "Opens the parent communication scheduler" },
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      step="0.1" 
                      value={rate}
                      onChange={(e: any) => setRate(parseFloat(e.target.value))}
                      className="w-full"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      step="0.1" 
                      value={pitch}
                      onChange={(e: any) => setPitch(parseFloat(e.target.value))}
                      className="w-full"
                    />
                  </div>
...
// Original component
function SpeechRecognitionPage() {
  return (
    <Suspense fallback={
