...
// Fix: Use the correct import for Next.js dynamic
...
// Fix: Use the correct dynamic function from Next.js
const DynamicStudentDashboard = dynamic(() => Promise.resolve(StudentDashboard));
