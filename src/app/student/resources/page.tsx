...
function ResourcesPage() {
  ...
  const resources = [
    ...
    },
    {
      ...
      description: 'Learn how to analyze poetry with examples from famous poems and step-by-step guidance.',
      type: 'document',
      subject: 'english',
      yearGroup: 'Year 7',
      rating: 4.5,
        ...
        <Card className="card card-bordered bg-primary/5 hover:shadow-md transition-shadow">
          <CardHeader className="card-header">
            ...
            <CardDescription className="card-description">
              Create personalized learning materials tailored to your specific needs
            </CardDescription>
          </CardHeader>
