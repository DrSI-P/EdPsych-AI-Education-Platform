...
// Original component
function AdaptiveLearningAlgorithmsPage() {
              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Customise the adaptive learning algorithm parameters
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <motion.div variants={itemVariants} className="space-y-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <input 
                                ...
                                value={difficultyLevel}
                                onChange={(e: any) => setDifficultyLevel(parseInt(e.target.value))}
                                className="flex-grow"
                              />
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <input 
                                ...
                                value={adaptationSpeed}
                                onChange={(e: any) => setAdaptationSpeed(parseInt(e.target.value))}
                                className="flex-grow"
                              />
...
export default AdaptiveLearningAlgorithmsPage;