...
// Dynamic import for AIAvatarVideoComponent to prevent router issues
import Image from 'next/image';
import Link from 'next/link';
// Original component
const AIAvatarVideoComponent = dynamic(
  () => import('@/components/ai-avatar/ai-avatar-video-component').then(mod => ({ default: mod.AIAvatarVideoComponent }))
);
...
function AIAvatarVideoIntegrationPage() {
...
export default AIAvatarVideoIntegrationPage;