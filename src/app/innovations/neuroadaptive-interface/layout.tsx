...
export const metadata = {
  ...
  description: 'Experience our revolutionary neuroadaptive interface that adapts in real-time to your cognitive state, optimizing learning and reducing cognitive fatigue.',
};
