...
// Original component
function MultilingualSupportPage() {
  ...
  const getSelectedLanguageDetails = (): void => {
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Provide targeted support for English as an Additional Language (EAL) students, helping them transition whilst maintaining academic progress.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 mt-1 bg-primary/10 p-1 rounded-full">
