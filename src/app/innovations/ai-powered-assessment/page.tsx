...
// Original component
function AIPoweredAssessmentPage() {
                  ...
                  {(currentQuestion.type === 'short-answer' || currentQuestion.type === 'essay') && (
                    <div className="space-y-3">
                      <Textarea
                        ...
                        value={textAnswer}
                        onChange={(e: any) => setTextAnswer(e.target.value)}
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-muted/50 p-4 rounded-lg">
                        ...
                        <p className="text-sm mb-3">
                          Regular check-ins to track growth and ensure continued mastery of previously learnt concepts.
                        </p>
                        <Button size="sm">Timetable Check-in</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Save time with automated evaluation of complex responses whilst maintaining high-quality assessment and feedback.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="mr-2 mt-1 bg-primary/10 p-1 rounded-full">
...
export default AIPoweredAssessmentPage;