                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <Typography variant="body" className="mb-6">
                        This comprehensive course explores evidence-based approaches to creating truly inclusive learning environments that support all students. Developed by educational psychology experts, the programme provides practical strategies for removing barriers to learning and implementing universal design principles.
                      </Typography>
                ...
                <Card className="p-8">
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <Typography variant="body" className="mb-6">
                        This in-depth course provides educators with the knowledge and skills to effectively support learners with special educational needs. Based on current research and best practices, the programme covers a range of needs and evidence-based intervention approaches.
                      </Typography>
                ...
                <Card className="p-8">
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <Typography variant="body" className="mb-6">
                        This transformative course explores evidence-based approaches to behavior support that focus on understanding underlying causes and building positive relationships. Based on restorative principles and positive psychology, the programme provides practical strategies for creating supportive learning environments.
                      </Typography>
                ...
                <Card className="p-8">
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <Typography variant="body" className="mb-6">
                        This comprehensive course explores evidence-based assessment approaches that drive learning and inform teaching. Based on assessment for learning principles, the programme provides practical strategies for gathering meaningful data and using it to enhance educational outcomes.
                      </Typography>
