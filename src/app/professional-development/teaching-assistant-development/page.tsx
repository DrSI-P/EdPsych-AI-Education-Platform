...
// Original component
function TeachingAssistantDevelopment() {
  return (
              ...
              <CardContent className="space-y-6">
                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>
                          ...
                          <p className="text-sm text-muted-foreground">TAs working with lower-attaining pupils whilst teachers focus on higher-attaining groups, reducing access to qualified teaching.</p>
                        </li>
                        <li>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-l-4 border-primary pl-4 py-2">
                      ...
                      <p className="text-sm italic mt-1">
                        Implementation: Timetable regular meeting time between teachers and TAs, share lesson plans in advance, and provide clear guidance on learning objectives.
                      </p>
                    </div>
                    ...
                    <table className="w-full text-sm text-left">
                      ...
                      <tbody>
                        ...
                        <tr className="border-b bg-muted/50">
                          ...
                          <td className="px-6 py-4">Supporting access to whole-class teaching whilst providing additional scaffolding</td>
                        </tr>
                        <tr className="border-b">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <ul className="list-disc pl-5 space-y-1 mb-4">
                    ...
                    <li>Many TAs worked with lower-attaining groups whilst teachers focused on higher-attaining pupils</li>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <ul className="list-disc pl-8 space-y-1 mt-2">
                        ...
                        <li>Timetable regular (e.g., fortnightly) longer planning meetings</li>
                        <li>Use standardised lesson plan templates with clear TA guidance sections</li>
                      </ul>
                    </div>
...
export default TeachingAssistantDevelopment;