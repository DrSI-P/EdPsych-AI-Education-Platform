...
// Original component
function TechnologyInEducation() {
  return (
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mb-4">
                    Effective AI policies for schools must address several critical areas to ensure that technology enhances learning whilst protecting students and staff:
                  </p>
                    ...
                    <table className="w-full text-sm text-left">
                      ...
                      <tbody>
                        ...
                        <tr className="border-b bg-muted/50">
                          ...
                          <td className="px-6 py-4">
                            <ul className="list-disc pl-4">
                              <li>Finalise and publish AI policy</li>
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <ol className="list-decimal pl-5 space-y-1 mb-4">
                    ...
                    <li>Finalised and implemented the policy with supporting resources and training</li>
                  </ol>
                  ...
                  <ul className="list-disc pl-5 space-y-1 mb-4">
                    ...
                    <li>Regular review and update timetable</li>
                  </ul>
                  ...
                  <p>
                    ...
                    whilst students developed better understanding of appropriate AI use. The school established an "AI Innovation Group" to continuously evaluate new technologies 
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground pl-4">
                        Outline the ethical principles guiding AI use in your school (e.g., fairness, transparency, human-centred approach).
                      </p>
                    </div>
