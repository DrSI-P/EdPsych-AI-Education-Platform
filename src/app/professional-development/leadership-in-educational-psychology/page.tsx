...
// Original component
function LeadershipInEducationalPsychology() {
  return (
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mb-4">
                    The UK government has recognized the importance of wellbeing in education through initiatives such as the Wellbeing for Education Return programme 
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <ul className="list-disc pl-5 space-y-1 mb-4">
                    <li>Implemented a whole-school approach to emotional literacy using the RULER programme</li>
                    ...
                    <li>Developed a parent education programme on adolescent mental health</li>
                  </ul>
...
export default LeadershipInEducationalPsychology;