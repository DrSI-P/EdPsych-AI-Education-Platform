      ...
      <main className="flex-grow container mx-auto py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Quick, focused learning resources designed to fit into your busy timetable. Build your knowledge in just 5-15 minutes at a time.
          </p>
        </div>
        ...
        <div className="mt-16 bg-muted rounded-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Customise your professional development by selecting micro-learning resources that align with your interests and needs.
            </p>
          </div>
