...
// Original component
function ParentFamilyEngagement() {
  return (
            ...
            <Card>
              ...
              <CardContent>
                <nav className="space-y-2">
                  ...
                  <div className="flex items-center justify-between p-2 hover:bg-muted rounded-md">
                    <span>3. Family-Centred Intervention Approaches</span>
                    <Badge variant="outline">Locked</Badge>
                  </div>
                  <div className="flex items-center justify-between p-2 hover:bg-muted rounded-md">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <ul className="list-disc pl-5 space-y-1 mb-4">
                    ...
                    <li>Established a "Parents as Partners in Learning" programme with practical workshops</li>
...
export default ParentFamilyEngagement;