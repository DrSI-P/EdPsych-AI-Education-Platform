...
// Original component
function TraumaInformedPractice() {
  return (
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                    ...
                    <table className="w-full text-sm text-left">
                      ...
                      <tbody>
                        ...
                        <tr className="bg-muted/50">
                          ...
                          <td className="px-6 py-4">Behavioural challenges, dissociation</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-primary pl-4 py-2">
                      ...
                      <p className="text-sm italic mt-1">
                        Often misinterpreted as: Behavioural problems, oppositional defiant disorder, or conduct issues.
                      </p>
                    </div>
                ...
                <div className="bg-muted p-6 rounded-lg">
                  ...
                  <p className="mb-4">
                    Initially, staff considered whether Jamie might have ADHD or behavioural issues. However, a trauma-informed approach revealed that Jamie's 
...
export default TraumaInformedPractice;