...
// Note: Server-side exports like dynamicConfig, revalidate, and fetchCache cannot be used with 'use client'
...
function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-primary">
      {/* MainNavigation handled by layout */}
      ...
      <section className="py-section bg-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="card">
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        className="border-default focus:border-primary focus:ring-primary"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label htmlFor="enquiryType" className="block text-sm font-medium text-secondary mb-2">
                        Enquiry Type *
                      </label>
                      <select
                        id="enquiryType"
                        ...
                        onChange={handleInputChange}
                        className="w-full px-3 py-2 border border-default rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
                      >
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                {contactMethods.map((method, index) => {
                  ...
                  return (
                    <Card key={index} className="card hover:shadow-lg transition-all">
            ...
            {/* Team Highlights */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-6">Why Choose EdPsych Connect?</h2>
              <div className="space-y-4">
                {teamHighlights.map((highlight, index) => {
                  const IconComponent = highlight.icon;
                  return (
                    <div key={index} className="flex items-start space-x-4">
                      <div className="w-10 h-10 bg-primary-lightest rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <Card className="bg-accent border-primary/20">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  <a href="/meet-dr-scott" className="block text-primary hover:text-primary-dark text-sm">
                    → Ask Dr. Scott a Question
                  </a>
                  <a href="/about/team" className="block text-primary hover:text-primary-dark text-sm">
                    → Meet Our Team
                  </a>
                  <a href="/platform-overview" className="block text-primary hover:text-primary-dark text-sm">
                    → Explore Platform Features
                  </a>
                  <a href="/accessibility" className="block text-primary hover:text-primary-dark text-sm">
