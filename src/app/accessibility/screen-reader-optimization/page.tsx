...
// Original component
function ScreenReaderOptimizationPage() {
                  ...
                  <TabsContent value="benefits" className="space-y-4 pt-4">
                    <div className="prose max-w-none dark:prose-invert">
                      ...
                      <ul>
                        ...
                        <li>
                          <strong>Multitasking:</strong> Allows users to consume content whilst engaged in other activities
                        </li>
                        <li>
...
export default ScreenReaderOptimizationPage;