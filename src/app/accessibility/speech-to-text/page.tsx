...
const SpeechToTextEngine = dynamic(
  () => import('@/components/ai/accessibility/speech-to-text-engine').then(mod => ({ default: mod.SpeechToTextEngine }))
);
...
function SpeechToTextPage() {
  ...
  const samplePrompts = {
    ...
    secondary: "Explain what you learnt in science class today",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="mt-6">
            ...
            <Textarea 
              value={sampleText}
              onChange={(e: any) => setSampleText(e.target.value)}
                ...
                <TabsContent value="benefits" className="space-y-4 pt-4">
                  <div className="prose max-w-none dark:prose-invert">
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>Multitasking:</strong> Enables note-taking whilst viewing materials or performing other tasks
                      </li>
                    </ul>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="usage" className="space-y-4 pt-4">
                  <div className="prose max-w-none dark:prose-invert">
                    ...
                    <ul>
                      ...
                      <li>Take notes during lectures or whilst reading</li>
                      <li>Brainstorm ideas for projects</li>
                      <li>Complete written assignments when typing is challenging</li>
                      <li>Practice oral language skills whilst seeing text output</li>
                    </ul>
