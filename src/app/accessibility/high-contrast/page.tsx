                  ...
                  <TabsContent value="benefits" className="space-y-4 pt-4">
                    <div className="prose max-w-none dark:prose-invert">
                      ...
                      <ul>
                        ...
                        <li>
                          <strong>Customisation:</strong> Allows personalization to meet individual visual needs
                        </li>
                        <li>
...
export default HighContrastPage;