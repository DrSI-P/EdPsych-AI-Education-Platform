...
function InteractiveVideoDemoContent() {
  return (
      ...
      <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <VideoPlayer
            ...
            questions={[
              ...
              },
              {
                ...
                explanation: "Social cognitive theory, developed by Albert Bandura, emphasises the importance of observing and modelling the behaviours, attitudes, and emotional reactions of others. It explains human behavior in terms of continuous reciprocal interaction between cognitive, behavioural, and environmental influences."
              }
            ]}
            nextVideos={[
              {
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <p className="text-gray-700 mt-4">
            ...
            content management system, with personalized recommendations based on the learner&apos;s profile and progress.
          </p>
        </div>
      </div>
    </div>
