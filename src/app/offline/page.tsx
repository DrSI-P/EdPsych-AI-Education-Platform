...
// Dynamic import for EnhancedAccessibilityWrapper to prevent router issues
/**
 ...
 */
const EnhancedAccessibilityWrapper = dynamic(
  () => import('@/components/accessibility/enhanced-accessibility-components').then(mod => ({ default: mod.EnhancedAccessibilityWrapper }))
);
