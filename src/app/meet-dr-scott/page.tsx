  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/ask-dr-scott', {
        ...
        body: JSON.stringify(questionForm, { cache: "no-store" }),
      });
      ...
      <div className="py-12 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Chat with Dr. Scott</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Ask questions directly to Dr. Scott's AI avatar and get immediate responses based on his expertise in educational psychology.
            </p>
          </div>
          
          <AskDrScottAvatar
            avatarId="e12f05f24ead42619b4aa8124d98880d"
            initialMessage="Hello, I'm Dr. Scott I-Patrick. How can I help you with your educational psychology questions today?"
            className="mb-8"
          />
          
          <div className="text-center mt-6">
            <p className="text-sm text-gray-500">
              This interactive avatar provides immediate responses based on Dr. Scott's expertise. For personalized advice or complex questions, please use the form below.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Areas of specialisation and professional focus
            </p>
          </div>
      ...
      <div className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            For urgent matters or to timetable a consultation, contact Dr. Scott directly
          </p>
...
export default MeetDrScottPage;