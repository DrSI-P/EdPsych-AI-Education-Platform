...
const CreateResourcesWrapper = dynamic(
  () => import('@/components/resources/create/create-resources-wrapper'),
  { ssr: false }
);
...
// Removed invalid standalone statement: CreateResourcesWrapper