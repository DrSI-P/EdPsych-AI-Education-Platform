    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
        <div className="px-4 py-5 sm:px-6">
          <h2 className="text-lg leading-6 font-medium text-gray-900">Your Credits</h2>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-8">
        <div className="px-4 py-5 sm:px-6">
          <h2 className="text-lg leading-6 font-medium text-gray-900">Purchase Credits</h2>
          <p className="mt-1 max-w-2xl text-sm text-gray-500">
            ...
            {CREDIT_PACKAGES.map((pkg) => (
              <div key={pkg.name} className="bg-white border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <div className="p-4 border-b">
                  <h3 className="text-lg font-medium text-gray-900">{pkg.displayName}</h3>
      ...
      {credits.length > 0 && (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6">
            <h2 className="text-lg leading-6 font-medium text-gray-900">Credit History</h2>
            <p className="mt-1 max-w-2xl text-sm text-gray-500">
