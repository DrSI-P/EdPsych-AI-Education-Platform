      ...
      <div className="container mx-auto py-8 max-w-4xl">
        ...
        <Card className="p-6 mb-8">
          <Text className="text-xl mb-4">
            This Biscuit Policy explains how EdPsych AI ("we", "us", or "our") uses cookies and similar technologies on our platform to enhance your experience, analyze usage, and assist in our marketing efforts.
          </Text>
          
          <Text className="mb-4">
            By using the EdPsych AI Platform, you consent to the use of cookies in accordance with this Biscuit Policy. If you do not accept the use of cookies, you can disable them through your browser settings or our biscuit preference center, but this may affect your ability to use certain features of our platform.
          </Text>
        ...
        <Card className="p-6 mb-8">
          ...
          <div className="space-y-6 mb-4">
            ...
            <div className="bg-muted p-4 rounded-md">
              ...
              <Text className="text-sm italic">
                Example: Cookies that remember your preferences, such as text size, language, or color scheme.
              </Text>
            </div>
        ...
        <Card className="p-6 mb-8">
          ...
          <Heading level="h3" className="text-lg mt-4 mb-2">Biscuit Preference Center</Heading>
          <Text className="mb-4">
            You can manage your biscuit preferences through our Biscuit Preference Center, which allows you to accept or reject specific categories of cookies.
          </Text>
