              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Manage your payment methods through our secure billing portal.
                  </p>
                  <Button 
                    onClick={handleBillingPortal}
                    disabled={isProcessing}
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Update your billing address through our secure billing portal.
                  </p>
                  <Button 
                    variant="outline"
                    onClick={handleBillingPortal}
        ...
        <TabsContent value="usage">
          <Card>
            ...
            <CardContent>
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-medium mb-2">User Seats</h3>
                  <p className="text-muted-foreground mb-2">
                    Your subscription includes {subscription.quantity} user seats.
                  </p>
                  <div className="flex items-center gap-4 mb-4">
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => handleUpdateQuantity(Math.max(1, subscription.quantity - 1))}
                      disabled={isProcessing || subscription.quantity <= 1}
                    >
                      -
                    </Button>
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => handleUpdateQuantity(subscription.quantity + 1)}
                      disabled={isProcessing}
                    >
                      +
                    </Button>
                  ...
                  <Button 
                    variant="outline"
                    onClick={() => handleUpdateQuantity(subscription.quantity)}
                    disabled={isProcessing}
                  >
                    Update Seats
                  </Button>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Monitor your usage of platform features.
                  </p>
                  <Button 
                    variant="outline"
                    onClick={() => router.push(`/admin/tenants/${tenantId}/subscription/usage`)}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Button 
                    ...
                    disabled={isProcessing}
                  >
                    {subscription.cancelAtPeriodEnd ? "Enable Auto-Renewal" : "Disable Auto-Renewal"}
                  </Button>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Your current billing cycle is {getBillingIntervalText(subscription.billingInterval)}.
                    To change your billing cycle, you'll need to update your subscription plan.
                  </p>
                  <Button 
                    variant="outline"
                    onClick={() => router.push(`/admin/tenants/${tenantId}/subscription/pricing`)}
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Cancel your subscription immediately. This action cannot be undone.
                  </p>
                  <Button 
                    variant="destructive"
                    onClick={() => handleCancelSubscription(false)}
