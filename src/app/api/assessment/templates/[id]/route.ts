...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'An error occurred whilst fetching the assessment template' },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'An error occurred whilst updating the assessment template' },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'An error occurred whilst deleting the assessment template' },
      { status: 500 }
    );
  }
}
