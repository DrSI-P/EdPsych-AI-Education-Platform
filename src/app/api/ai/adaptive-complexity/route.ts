...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `
      ...
      ${settings?.preserveMultiModal ? 'Preserve all multi-modal elements (images, videos, interactive components) whilst adapting the text complexity.' : 'Focus on adapting the text content; you may simplify or modify multi-modal elements as needed.'}
