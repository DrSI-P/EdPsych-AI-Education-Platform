...
async function handleSessionCreated(data: unknown) {
...
async function handleSessionReady(data: unknown) {
...
async function handleAvatarResponse(data: unknown) {
...
async function handleSessionEnded(data: unknown) {
...
async function handleStreamingError(data: unknown) {
