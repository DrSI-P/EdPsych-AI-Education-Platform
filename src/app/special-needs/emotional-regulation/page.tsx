...
const EmotionalRegulationEngine = dynamic(
  () => import('@/components/special-needs/emotional-regulation/emotional-regulation-engine')
);

function EmotionalRegulationPage() {
  return (
        ...
        <TabsContent value="about" className="py-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p>
                Whilst all students benefit from developing emotional regulation skills, this tool is particularly 
                helpful for:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  <h4 className="font-semibold">Dialectical Behavior Therapy (DBT)</h4>
                  <p>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li>
                  ...
                  emotional regulation skills are strongly correlated with academic achievement and classroom behavior.
                </li>
                <li>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li>
                  <strong>Department for Education's</strong> guidance on mental health and behavior in schools
                </li>
                <li>
              ...
              <div className="bg-gray-100 p-4 rounded-md mt-6">
                ...
                <ul className="list-disc pl-6 space-y-2 mt-2 text-sm">
                  <li>Department for Education (2018). Mental health and behavior in schools. London: DfE.</li>
...
export default EmotionalRegulationPage;