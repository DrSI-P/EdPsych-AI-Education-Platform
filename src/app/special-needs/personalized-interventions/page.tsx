...
function PersonalizedInterventionsPage(): React.ReactNode {
              ...
              <Tabs defaultValue="benefits">
                ...
                <TabsContent value="research" className="space-y-4 pt-4">
                  <div className="prose max-w-none dark:prose-invert">
                    ...
                    <p>
                      Research from the National Center on Intensive Intervention demonstrates that systematic data collection and analysis is essential for optimising intervention effectiveness.
                    </p>
                  </div>
                </TabsContent>
...
const PersonalizedInterventionsEngine = dynamic(
  () => import('@/components/special-needs/personalized-interventions/personalized-interventions-engine')
);

export default PersonalizedInterventionsPage;