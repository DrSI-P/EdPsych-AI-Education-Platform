...
// Original component
function SensoryRegulationPage(): React.ReactNode {
  return (
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Incorporates principles from the Alert Programme® (&quot;How Does Your Engine Run?&quot;) to help students recognize and regulate their alertness levels for optimal learning.
                </p>
              </div>
              <div className="space-y-2">
...
export default SensoryRegulationPage;