...
function ProgressMonitoringPage(): React.ReactNode {
...
const ProgressMonitoringEngine = dynamic(
  () => import('@/components/special-needs/progress-monitoring/progress-monitoring-engine')
);
