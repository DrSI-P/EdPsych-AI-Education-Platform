...
export default function VideoViewPage() {
  ...
  const videoData = {
    '973a9f4857e14071bb2e5082bb40135b': {
      ...
      transcript: 'Hello! I\'m Dr. Scott I-Patrick, DEdPsych, BSc, CPsychol, MBPSs - a Chartered Educational Psychologist and the founder of EdPsych Connect. With over 20 years of experience in education and 12 years specialising in educational psychology, I\'m here to provide you with expert guidance and support...',
      keyPoints: [
...
// Removed invalid standalone statement: VideoViewPage