...
import { MultiModalContentWithParams } from './multi-modal-content-with-params';
          ...
          <TabsContent value="create" className="pt-4">
            <div className="space-y-8">
              <Suspense fallback={<div>Loading content...</div>}>
                <MultiModalContentWithParams content={content} setContent={setContent} router={router} />
              </Suspense>
            </div>
          </TabsContent>
