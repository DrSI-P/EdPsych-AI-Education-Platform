...
const MultiModalPresentationEngine = dynamic(
  () => import('@/components/ai/multi-modal-content/multi-modal-presentation-engine')
);
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p>
                    Our multi-modal content presentation system is built on established research in cognitive load theory, dual coding theory, and multimedia learning principles. The system implements best practices for presenting information across multiple modalities whilst avoiding cognitive overload.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    All multi-modal content maintains alignment with UK curriculum standards and uses UK English spelling and terminology. The system ensures that whilst the presentation format is enhanced, the core learning objectives and curriculum requirements are preserved and reinforced.
                  </p>
                </div>
...
// Original component
function MultiModalContentPage() {
  return (
    <Suspense fallback={
...
const MultiModalContentPageWrapper = dynamic(
  () => Promise.resolve(MultiModalContentPage),
  { 
    ssr: false,
    loading: () => (
...
export default MultiModalContentPageWrapper;