...
function ParentCommunicationPage() {
  ...
  const recentCommunications = [
    ...
    { id: 2, student: 'Sarah Johnson', parent: 'Dr Johnson', type: 'Phone', subject: 'Behavior Discussion', date: '3 days ago', status: 'Completed' },
          ...
          >
            <Card className="card card-bordered hover:shadow-md transition-shadow">
              ...
              <CardContent className="card-body">
                ...
                {/* Timetable New Message Button */}
                <div className="flex justify-center mt-8">
                  <Button className="btn btn-primary">
                    Timetable New Message
                  </Button>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="mb-4 md:mb-0 md:mr-6 flex-grow">
                ...
                <p className="text-muted-foreground">
                  Save time by using voice commands to compose messages, select recipients, and timetable communications.
                </p>
              </div>
