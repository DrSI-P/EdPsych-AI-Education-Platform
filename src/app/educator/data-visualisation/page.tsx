  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl md:text-4xl font-bold text-primary mb-2">Data Visualization</h1>
        <p className="text-muted-foreground text-lg">
          Analyze student performance and identify trends with interactive data visualisations.
        </p>
      </motion.div>
