...
// Original component
function AdministrativeAutomationPage() {
                          ...
                          <div className="border border-border rounded-lg p-4 hover:bg-muted/30 cursor-pointer transition-colors">
                            <div className="flex items-center mb-2">
                              <input 
                                ...
                                className="mr-2"
                              />
                              <label htmlFor="behavior" className="font-medium">Behavior</label>
                            </div>
                            <p className="text-sm text-muted-foreground">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td className="py-3 px-4">Behavior Incident Report</td>
                            <td className="py-3 px-4">
                              <Badge variant="outline" className="badge badge-outline">
                                Behavior
                              </Badge>
                  ...
                  <CardContent className="card-body p-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          All marking criteria are aligned with UK assessment standards, including National Curriculum levels, GCSE and A-Level mark boundaries.
                        </p>
                      </div>
                    </div>
                  </CardContent>
              ...
              <CardContent className="card-body">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <Card className="card card-bordered hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="card-body">
                      <p className="text-sm text-muted-foreground mb-4">
                        Set up automatic notifications for parents based on student performance, attendance, or behavior.
                      </p>
                      <div className="space-y-3">
                        <div className="flex items-center">
                          <input 
                        ...
                        <div className="flex items-center">
                          <input 
                            ...
                            className="mr-2"
                          />
                          <label htmlFor="gradingAlerts">Assignment Marking Alerts</label>
                        </div>
                        ...
                        <div className="flex items-center">
                          <input 
                            ...
                            className="mr-2"
                          />
                          <label htmlFor="behaviourAlerts">Behavior Incident Alerts</label>
                        </div>
                      </div>
                    </CardContent>
                  ...
                  <Card className="card card-bordered hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="card-body">
                      <p className="text-sm text-muted-foreground mb-4">
                        Timetable regular communications to parents, such as weekly updates or term summaries.
                      </p>
                      <div className="space-y-3">
                        <div className="flex items-center">
                          <input 
                  ...
                  <Card className="card card-bordered hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="card-body">
                      <p className="text-sm text-muted-foreground mb-4">
                        Send personalized messages to multiple parents at once with mail merge capabilities.
                      </p>
                      <div className="space-y-3">
                        <div className="flex items-center">
                          <input 
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Button variant="outline" className="h-auto py-3 btn btn-outline">
                      <div className="text-left">
                        <div className="font-medium">Positive Behavior</div>
                        <div className="text-xs text-muted-foreground mt-1">Recognition of good behavior</div>
                      </div>
                    </Button>
...
export default AdministrativeAutomationPage;