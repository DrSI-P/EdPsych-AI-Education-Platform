...
const CalendarOptimizationWrapper = dynamic(
  () => import('@/components/educator/calendar-optimization-wrapper'),
  { ssr: false }
);

function CalendarOptimizationPage() {
  return (
        ...
        <TabsContent value="about">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                The Calendar Optimization feature is designed to help educators efficiently plan, organise, and optimize their professional activities whilst balancing teaching responsibilities, administrative tasks, meetings, and professional development.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Wellness and Workload Management:</strong> Features to prevent timetable overloading and maintain work-life balance.
                </li>
              </ul>
              ...
              <p className="mt-4">
                By intelligently optimizing how educators allocate their time and timetable their activities, this feature significantly reduces administrative burden whilst ensuring that high-impact educational activities receive appropriate focus and resources.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>Begin by adding your regular teaching timetable and recurring meetings</li>
                <li>Use the activity types to categorize different kinds of work</li>
                <li>Set appropriate priorities for each activity</li>
                <li>Use the optimization feature to receive suggestions for improving your timetable</li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Timetable breaks:</strong> Include short recovery periods between intensive teaching sessions
                </li>
                <li>
