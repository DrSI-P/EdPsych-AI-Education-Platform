        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-8 mb-8">
              ...
              <Typography variant="body" className="mb-4">
                Users retain ownership of any content they create, upload, or share on our platform ("User Content"). By submitting User Content, you grant EdPsych Connect a non-exclusive, worldwide, royalty-free licence to use, store, display, reproduce, and distribute your User Content solely for the purpose of providing and improving our Services.
              </Typography>
            ...
            <Card className="p-8 mb-8">
              ...
              <Typography variant="body" className="mb-4">
                Subject to these Terms, we grant you a limited, non-exclusive, non-transferable, and revocable licence to access and use our Services for your personal, non-commercial use. This licence does not include the right to:
              </Typography>
