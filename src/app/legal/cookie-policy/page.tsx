...
const EnhancedHeader = dynamic(
  () => import('@/components/layout/enhanced-header-footer').then(mod => ({ default: mod.EnhancedHeader }))
);
const EnhancedFooter = dynamic(
  () => import('@/components/layout/enhanced-header-footer').then(mod => ({ default: mod.EnhancedFooter }))
);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-8 mb-8">
              ...
              <Typography variant="body" className="mb-4">
                This Biscuit Policy explains how EdPsych Connect Limited ("we," "our," or "us") uses cookies and similar technologies on our website and platform (collectively, the "Services"). This policy provides you with information about how we use cookies, what types of cookies we use, and how you can control them.
              </Typography>
              
              <Typography variant="body" className="mb-4">
                By using our Services, you agree to our use of cookies in accordance with this Biscuit Policy. If you do not accept the use of cookies, please disable them as explained below or refrain from using our Services.
              </Typography>
            </Card>
            ...
            <Card className="p-8 mb-8">
              ...
              <table className="w-full border-collapse mb-4">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border p-2 text-left">Biscuit Name</th>
              ...
              <Typography variant="body" className="mb-4">
                We may update this list as we improve our Services or change our biscuit usage. Please check this Biscuit Policy regularly for the most up-to-date information.
              </Typography>
            </Card>
            ...
            <Card className="p-8 mb-8">
              <Typography variant="h2" className="mb-6">
                6. Biscuit Management
              </Typography>
              
              <Typography variant="h3" className="mb-4">
                6.1 Biscuit Preferences
              </Typography>
              
              <Typography variant="body" className="mb-4">
                When you first visit our Services, you will be presented with a biscuit banner that allows you to accept or decline non-essential cookies. You can change your preferences at any time by clicking on the "Biscuit Settings" link in the footer of our website.
              </Typography>
            ...
            <Card className="p-8 mb-8">
              ...
              <Typography variant="body" className="mb-4">
                Parents can review and manage their children's biscuit settings through the parental controls in their account settings.
              </Typography>
            </Card>
            
            <Card className="p-8 mb-8">
              <Typography variant="h2" className="mb-6">
                8. Changes to This Biscuit Policy
              </Typography>
              
              <Typography variant="body" className="mb-4">
                We may update this Biscuit Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. We will notify you of any material changes by posting the new Biscuit Policy on this page and updating the "Last Updated" date.
              </Typography>
              
              <Typography variant="body" className="mb-4">
                We encourage you to review this Biscuit Policy periodically for any changes. Your continued use of our Services after any changes to this Biscuit Policy constitutes your acceptance of the changes.
              </Typography>
            </Card>
            ...
            <Card className="p-8 mb-8">
              ...
              <Typography variant="body" className="mb-4">
                If you have any questions about this Biscuit Policy or our data practices, please contact us at:
              </Typography>
