...
const mockInterventionRecommendations = [
  {
    ...
    expectedImpact: 'HIGH',
    resourceRequirements: 'Teacher or tutor, 3 sessions per week, 30 minutes per session',
  ...
  },
  {
    ...
    expectedImpact: 'HIGH',
    resourceRequirements: 'Tutor, 2 sessions per week, 20 minutes per session',
...
export default function PredictiveDashboardPage() {
  ...
  const getInterventionStatusBadge = (status): void => {
    switch (status) {
      case 'COMPLETED':
  ...
  const getEffectivenessBadge = (effectiveness): void => {
  ...
  const getExpectedImpactBadge = (impact): void => {
    switch (impact) {
      case 'HIGH':
        return <Badge className="bg-green-100 text-green-800 border-green-200">High Impact</Badge>;
      case 'MEDIUM':
  ...
  const getPerformanceDifference = (current, predicted): void => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium mb-1">Learning Gap Plenary</h4>
                        <p className="text-sm">
