...
const VoiceNavigationShortcuts = dynamic(
  () => import('@/components/voice-input/enhanced/voice-navigation-shortcuts'),
  { ssr: false }
);

function VoiceNavigationShortcutsDemo() {
  return (
...
const PageWrapper = dynamic(
  () => Promise.resolve(VoiceNavigationShortcutsDemo),
  { 
    ssr: false,
    loading: () => (
