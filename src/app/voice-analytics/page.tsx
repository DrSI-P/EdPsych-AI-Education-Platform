...
const VoiceAnalyticsDashboard = dynamic(
  () => import('@/components/voice-input/enhanced/voice-analytics-dashboard')
);
...
const VoiceAnalyticsPageWrapper = dynamic(
  () => Promise.resolve(VoiceAnalyticsPage),
  { 
    ssr: false,
    loading: () => (
...
export default VoiceAnalyticsPageWrapper;