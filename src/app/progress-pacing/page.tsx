...
const ProgressPacingContent = (): void => {
...
const ProgressPacingEngine = dynamic(
  () => import('@/components/ai/progress-pacing/progress-pacing-engine')
);

function ProgressPacingPage() {
  return (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p>
                    Our progress-adaptive pacing system is built on established research in mastery learning, spaced repetition, and the zone of proximal development. The system implements best practices for pacing educational content whilst ensuring deep understanding and knowledge retention.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    All pacing adjustments maintain alignment with UK curriculum standards and progression expectations. The system ensures that whilst the pace may be personalized, the core learning objectives and curriculum requirements are preserved and achieved.
                  </p>
                </div>
...
const ProgressPacingPageWrapper = dynamic(
  () => Promise.resolve(ProgressPacingPage),
  { 
    ssr: false,
    loading: () => (
...
export default ProgressPacingPageWrapper;