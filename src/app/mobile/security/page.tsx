                  ...
                  {autoLockEnabled && (
                    <div className="flex items-center justify-between pl-4">
                      ...
                      <select 
                        id="auto-lock-time" 
                        value={autoLockTime}
                        onChange={(e: any) => setAutoLockTime(e.target.value)}
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <select className="text-xs p-1 border rounded">
                        <option>Allow</option>
                        <option>Allow Whilst Using</option>
                        <option>Ask Every Time</option>
                        <option>Deny</option>
                      </select>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Customise content based on your activity</p>
                      </div>
                      <input type="checkbox" className="h-4 w-4" defaultChecked />
                    </div>
