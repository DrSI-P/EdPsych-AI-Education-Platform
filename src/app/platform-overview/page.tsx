...
export default function PlatformOverview() {
  ...
  const dashboards = [
    {
      ...
      description: "Personalized learning paths, progress tracking, and achievement management for students.",
      icon: GraduationCap,
      color: "bg-blue-500",
  ...
  const innovations = [
    {
      ...
      features: ["Adaptive testing", "Instant feedback", "Learning analytics", "Personalized recommendations"]
    },
    {
      ...
      features: ["Adaptive content", "Learning style detection", "Progress optimization", "Interest-based learning"]
    },
    {
    ...
    },
    {
      ...
      features: ["Stress monitoring", "Attention tracking", "Wellness insights", "Performance optimization"]
    },
    {
  ...
  const renderFeatureCard = (item: unknown) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              personalized dashboards, and innovative learning technologies.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-3">
                  <Button variant="outline" className="w-full justify-start" onClick={() => router.push('/innovations/student-dashboard')}>
                    <GraduationCap className="w-4 h-4 mr-2" />
                    Student Dashboard
                  </Button>
                  <Button variant="outline" className="w-full justify-start" onClick={() => router.push('/innovations/educator-dashboard')}>
                    <BarChart3 className="w-4 h-4 mr-2" />
                    Educator Dashboard
                  </Button>
                  <Button variant="outline" className="w-full justify-start" onClick={() => router.push('/innovations/parent-portal')}>
                    <Heart className="w-4 h-4 mr-2" />
                    Parent Portal
                  </Button>
                  <Button variant="outline" className="w-full justify-start" onClick={() => router.push('/innovations/ai-powered-assessment')}>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              onClick={() => router.push('/innovations/student-dashboard')}
            >
