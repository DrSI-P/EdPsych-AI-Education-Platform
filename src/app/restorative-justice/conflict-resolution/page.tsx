...
function ConflictResolutionPage() {
  ...
  const caseStudies = [
    ...
    },
    {
      ...
      outcome: "Improved classroom behavior and engagement",
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <motion.div variants={itemVariants}>
                      ...
                      <p className="text-muted-foreground mb-4">
                        Document agreements, establish monitoring mechanisms, and timetable follow-up meetings to ensure progress and accountability.
                      </p>
                      <div className="bg-primary/5 p-4 rounded-lg border border-primary/10">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              <h5 className="font-medium">Timetable Check-ins</h5>
                            ...
                            <div className="mt-6 space-y-4">
                              ...
                              <div className="bg-white p-4 rounded-lg border">
                                ...
                                <ul className="list-disc pl-5 space-y-1 text-sm">
                                  ...
                                  <li>What have you learnt from this experience?</li>
                                </ul>
                              </div>
                            </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    Restorative approaches align with the UK Department for Education's guidance on behavior management and social-emotional learning.
                  </p>
                  ...
                  <div className="bg-primary/5 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start">
                        ...
                        <span>Behavior and Discipline in Schools (DfE)</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                        <span>Mental Health and Behavior in Schools (DfE)</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">Improved behavior and attendance outcomes</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="bg-white">
                ...
                <CardContent className="pt-2">
                  <p className="text-sm text-muted-foreground mb-4">
                    Step-by-step guide for implementing restorative approaches across your school or organization.
                  </p>
              ...
              <Card className="bg-white">
                ...
                <CardContent className="pt-2">
                  <p className="text-sm text-muted-foreground mb-4">
                    Connect with educational psychologists and restorative practice experts for personalized guidance.
                  </p>
