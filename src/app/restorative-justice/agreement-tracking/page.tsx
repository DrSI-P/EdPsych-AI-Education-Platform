...
// Original component
function AgreementTrackingPage() {
  ...
  const agreements = [
    ...
    },
    {
      ...
      commitments: [
        ...
        { text: "Establish communication timetable", status: "Completed", assignedTo: "Group" },
    ...
    {
      id: 3,
      title: "Playground Behavior Plan",
                  ...
                  <CardContent>
                    <div className="space-y-8">
                      ...
                      <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
                        ...
                        <Button variant="ghost">
                          <Calendar className="h-4 w-4 mr-2" /> Timetable Reports
                        </Button>
                      </motion.div>
                    </div>
                  </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4 text-sm">
                  <p className="text-muted-foreground">
                    Agreement tracking aligns with UK educational frameworks for behavior management and restorative practices.
                  </p>
                  ...
                  <div className="bg-primary/5 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span>Supports Ofsted requirements for behavior monitoring</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                        <span>Aligns with DfE guidance on pupil behavior</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Timetable consistent follow-ups to monitor progress</p>
                    </div>
                  </div>
