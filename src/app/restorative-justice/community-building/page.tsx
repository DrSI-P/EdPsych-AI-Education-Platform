...
// Original component
function CommunityBuildingPage() {
  ...
  const getImpactColor = (impact): void => {
  ...
  const getCommunityScoreColor = (score): void => {
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Timetable regular community building activities</p>
                    </div>
                  </div>
                </div>
              </CardContent>
