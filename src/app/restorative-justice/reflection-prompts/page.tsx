...
// Original component
function ReflectionPromptsPage() {
      ...
      personal: [
        {
          ...
          questions: [
            "What have you learnt this week? (Add to your journey map)",
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <select 
                          ...
                          onChange={(e: any) => setSelectedAgeGroup(e.target.value)}
                        >
                        ...
                        <select 
                          ...
                          onChange={(e: any) => setSelectedPromptType(e.target.value)}
                        >
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Timetable consistent reflection time for maximum benefit</p>
                    </div>
                  </div>
...
export default ReflectionPromptsPage;