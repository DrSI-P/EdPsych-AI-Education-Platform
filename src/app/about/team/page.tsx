...
function TeamPage() {
  const teamMembers = [
    ...
    },
    {
      ...
      imageSrc: "/images/team/hannah-real.jpg",
      imagePosition: "center top",
      socialLinks: {
        linkedin: "#"
      },
    ...
    {
      name: "Hayley Baverstock",
      title: "Educational Consultant",
      qualifications: "Educational Consultancy & Learning Support",
      bio: "Hayley Baverstock serves as Educational Consultant for EdPsych Connect, bringing valuable expertise in educational consultancy and learning support. With extensive experience in educational settings, Hayley provides insights into practical classroom applications and helps bridge the gap between educational theory and real-world practice. Her consultancy ensures that the platform remains relevant and practical for educators and learners.",
      imageSrc: "/images/team/hayley-baverstock.jpg",
      imagePosition: "center top",
      socialLinks: {
        linkedin: "#"
      },
      ...
      avatarVideo: {
        src: "/videos/avatars/teacher/introduction/teacher_dr_scott_introduction_welcome.mp4",
        context: "feature",
        script: "Hello, I'm Hayley Baverstock, Educational Consultant at EdPsych Connect. I help bridge the gap between educational theory and real-world classroom practice, ensuring our platform remains relevant and practical for all educators."
      }
    },
    {
      name: "Sue Podolska",
      title: "Learning Development Specialist",
      qualifications: "Learning Development & Educational Resources",
      bio: "Sue Podolska serves as Learning Development Specialist for EdPsych Connect, focusing on creating and curating educational resources and learning materials. With expertise in learning development and educational resource design, Sue ensures that the platform's content is engaging, effective, and aligned with educational best practices. Her work is essential in maintaining the quality and effectiveness of the platform's learning resources.",
      imageSrc: "/images/team/sue-podolska.jpg",
      imagePosition: "center top",
      socialLinks: {
        linkedin: "#"
      },
      ...
      avatarVideo: {
        src: "/videos/avatars/specialist/instructional/specialist_collaboration_instructional_professional.mp4",
        context: "feature",
        script: "Hi, I'm Sue Podolska, Learning Development Specialist at EdPsych Connect. I focus on creating and curating educational resources that are engaging, effective, and aligned with educational best practices."
      }
    }
  ];
