...
const mockWellbeingActivities = [
  ...
  },
  {
    ...
    instructions: 'Set aside time each day for your child to write or draw 3 things they\'re grateful for. These can be simple things like a sunny day or a favourite toy.',
    ageRange: [6, 12],
  ...
  },
  {
    ...
    instructions: 'Take turns acting out different emotions whilst others guess. After guessing, discuss times when you might feel that emotion and healthy ways to express it.',
    ageRange: [4, 10],
...
export default function EnhancedWellbeingPage() {
  ...
  const getFilteredWellbeingData = (): void => {
    const now = new Date();
    let startDate;
  ...
  const getFilteredInsights = (): void => {
  ...
  const getRelevantResources = (): void => {
  ...
  const getActivityLabel = (level): void => {
    switch (level) {
      case 'high':
  ...
  const getSocialLabel = (level): void => {
    switch (level) {
      case 'excellent':
  ...
  const getAnxietyLabel = (level): void => {
    switch (level) {
      case 'low':
  ...
  const getInsightPriorityBadge = (priority): void => {
    switch (priority) {
      case 'high':
  ...
  // Get insight icon
  const getInsightIcon = (type): void => {
    switch (type) {
      case 'alert':
  ...
  const getAverageWellbeingScore = (): void => {
  ...
  const getWellbeingScoreTrend = (): void => {
    const filteredData = getFilteredWellbeingData();
            ...
            <CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setNewEntry({...newEntry, sleepHours: parseFloat(e.target.value)})}
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setNewEntry({...newEntry, screenTime: parseFloat(e.target.value)})}
                    />
                  </div>
              ...
              <div className="mt-4">
                ...
                <Input 
                  ...
                  onChange={(e: any) => setNewEntry({...newEntry, notes: e.target.value})}
                />
              </div>
