              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={(e: any) => setNewCheckIn({...newCheckIn, notes: e.target.value})}
                  ></textarea>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  Records from school about Emma's behavior
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Overview of Emma's behavior records
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  ...
                  <p className="text-center text-sm">
                    <span className="font-medium">80%</span> of Emma's behavior records are positive
                  </p>
