...
export default function Home() {
  return (
    <div style={{ 
      ...
      <h2 style={{ color: '#666', fontWeight: 'normal' }}>Educational Psychology Platform</h2>
      ...
      <div style={{ 
        ...
        <p>Welcome to the EdPsych Connect platform. This is a simplified version of the homepage designed to verify Vercel deployment functionality.</p>
      ...
      <div style={{ marginTop: '40px' }}>
        ...
        <ul style={{ lineHeight: '1.8' }}>
          ...
          <li><a href="/index-minimal" style={{ color: '#0ea5e9' }}>Minimal Index Page</a></li>
        </ul>
      </div>
