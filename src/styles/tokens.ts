/**
 * Design Tokens for EdPsych-AI-Education-Platform
 * 
 * This file defines the core design tokens that form the foundation
 * of the platform's visual design system.
 */

// Color System
export const colors = {
  // Primary palette - educational psychology inspired
  primary: {
    50: '#eef2ff',
    100: '#e0e7ff',
    200: '#c7d2fe',
  ...
  // Secondary palette - warm, engaging colors
  secondary: {
    50: '#fdf4ff',
    100: '#fae8ff',
    200: '#f5d0fe',
