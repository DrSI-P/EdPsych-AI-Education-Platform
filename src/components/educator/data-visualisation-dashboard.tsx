...
const interventionEffectivenessData = [
  ...
  { name: 'Behavior Plan', before: 55, after: 70 },
...
const dashboardConfigs = [
  ...
  { id: 'behavior', name: 'Behavior & Wellbeing', isDefault: false },
...
export function DataVisualisationDashboard() {
  ...
  const renderDashboardHeader = (): void => {
    return (
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Data Visualization Dashboard</h2>
  ...
  const renderOverviewDashboard = (): void => {
    return (
