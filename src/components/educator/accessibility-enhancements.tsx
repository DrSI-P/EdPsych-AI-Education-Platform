 ...
 * allowing educators to customise their experience based on their needs.
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Customise your dashboard experience to meet your accessibility needs
        </CardDescription>
      </CardHeader>
          ...
          <TabsContent value="input" className="space-y-4 pt-4">
            ...
            <div className="p-4 bg-muted rounded-md">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li>"Timetable parent meeting"</li>
