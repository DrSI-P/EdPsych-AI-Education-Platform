...
Mrs. Thompson: Yes, thank you both for your time and support.
  ...
  },
  {
    ...
    language: 'en-GB',
    transcript: `
Ms. Johnson: Good afternoon everyone. Today we need to finalise our curriculum plans for the next academic year. Let's start with Year 7.
...
Ms. Thomas: One last item - the literacy intervention programme needs reviewing.
Ms. Johnson: Yes, let's timetable a separate meeting focused specifically on intervention strategies next week.
...
Ms. Johnson: Let\'s say Tuesday at 3:30 pm. I\'ll send a calendar invitation. Thank you all for your contributions today.
    ...
    keyPoints: [
      ...
      { text: 'Literacy intervention programme needs reviewing', category: 'issue', highlighted: false }
    ],
    actionItems: [
      ...
      { text: 'Timetable intervention strategy meeting', assignedTo: 'Ms. Johnson', dueDate: '2025-05-13', completed: true }
    ],
...
Speaker 1: Let's develop an action plan. Who can take responsibility for [Action Item]?
    ...
    setTimeout(() => {
      ...
      if (useEhcnaCategories) {
        sampleActionItems = [
          ...
          { 
            text: 'Timetable weekly check-in with school counselor', 
            assignedTo: 'SENCO', 
  ...
  const viewMeeting = (meeting): void => {
  ...
  const processUploadedFile = (): void => {
...
Speaker 1: Let's develop an action plan. Who can take responsibility for drafting the new assessment guidelines?
  ...
  const generateTranslation = (): void => {
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Textarea 
                          ...
                          onChange={(e: any) => setMeetingParticipants(e.target.value)}
                          disabled={isRecording}
                ...
                <CardContent>
                  <div className="space-y-4">
                    <Textarea 
                      ...
                      onChange={(e: any) => setLiveTranscript(e.target.value)}
