            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input 
                    id="lesson-title" 
                    value={lessonTitle} 
                    onChange={(e: any) => setLessonTitle(e.target.value)} 
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  id="resources" 
                  value={resources} 
                  onChange={(e: any) => setResources(e.target.value)} 
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  id="main-activity" 
                  value={mainActivity} 
                  onChange={(e: any) => setMainActivity(e.target.value)} 
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  id="plenary" 
                  value={plenary} 
                  onChange={(e: any) => setPlenary(e.target.value)} 
