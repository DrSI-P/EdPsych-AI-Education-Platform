...
export default function AutomatedDocumentation() {
      ...
      mediaRecorder.onstop = async () => {
        ...
        setTimeout(() => {
          ...
          const simulatedTranscriptions: Record<string, string> = {
            ...
            'support-strategies': 'Provide Emma with analytical writing frameworks. Timetable a 10-minute check-in every two weeks. Share time management techniques for exams. Recommend specific books based on her interests.',
            'follow-up': 'Timetable follow-up meeting for June 12th to review progress. Weekly quick checks on analytical writing samples. Email parents with update on goals and support strategies.',
          };
  ...
  const generateDocument = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "An error occurred whilst generating your document.",
        variant: "destructive"
      });
  ...
  const saveDocument = (): void => {
    ...
    try {
      ...
      toast({
        title: "Save Error",
        description: "An error occurred whilst saving your document.",
        variant: "destructive"
      });
