...
export function CalendarOptimization({ className = '' }: CalendarOptimizationProps) {
  ...
  const handleSelectActivity = (event): void => {
  ...
  const handleTogglePastEvents = (): void => {
    setFilters(prev => ({
      ...prev,
  ...
  // Delete activity
  const handleDeleteActivity = (): void => {
    if (!selectedActivity) return;
  ...
  // Duplicate activity
  const handleDuplicateActivity = (): void => {
    if (!selectedActivity) return;
  ...
  const generateOptimizationSuggestions = (focus: string) => {
    ...
    if (focus === 'balance' || focus === 'well-being') {
      suggestions.push({
        ...
        description: 'Timetable 15-minute breaks after intensive teaching sessions to maintain energy levels.',
  ...
  const handleApplySuggestion = (suggestion): void => {
    ...
    try {
      ...
      const data = {
        ...
        insights: [
          ...
          'Your meeting timetable appears to be efficiently managed'
        ]
      };
  ...
  const eventStyleGetter = (event): void => {
  ...
  const CustomToolbar = (toolbar): void => {
    const goToBack = (): void => {
      ...
      <Dialogue open={isOptimizeDialogOpen} onOpenChange={setIsOptimizeDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Let AI help you optimize your timetable for better productivity and well-being.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4">
            <div className="mb-4">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="balance">Balanced Timetable</SelectItem>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                {optimizationFocus === 'balance' && 'Create a well-balanced timetable with appropriate time for all activity types.'}
              ...
              <div className="text-center py-8">
                {isOptimizing ? (
                  <div className="flex flex-col items-center">
                    ...
                    <p>Analysing your calendar and generating optimization suggestions...</p>
                  </div>
                ) : (
                  <div>
