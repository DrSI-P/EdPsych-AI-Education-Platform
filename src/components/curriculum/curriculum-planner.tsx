        ...
        const mockPlans: any[] = [
          ...
          },
          {
            ...
            objectives: [
              ...
              'Analyze Shakespeare\'s use of language and dramatic techniques',
              ...
              <div className="space-y-2">
                {createForm.objectives.map((objective, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <Input
                      value={objective}
                      onChange={(e: any) => handleArrayFieldChange('objectives', index, e.target.value)}
              ...
              <div className="space-y-2">
                {createForm.resources.map((resource, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <Input
                      value={resource}
                      onChange={(e: any) => handleArrayFieldChange('resources', index, e.target.value)}
