  ...
  const generateStudentProfileRecommendations = (): Resource[] => {
    ...
    return [
      ...
      },
      {
        ...
        description: 'Audio narration of science experiments suitable for KS3, allowing students to listen whilst conducting experiments.',
        type: 'audio',
        ...
        curriculum: 'UK National Curriculum',
        relevanceScore: 0.89,
        relevanceReason: 'Leverages verbal reasoning strengths whilst supporting dyslexia',
        createdAt: '2025-02-10T14:30:00Z',
        updatedAt: '2025-02-10T14:30:00Z'
      },
      {
        ...
        curriculum: 'UK National Curriculum',
        relevanceScore: 0.86,
        relevanceReason: 'Builds on verbal reasoning strengths whilst reinforcing science concepts',
        createdAt: '2025-03-05T09:15:00Z',
        updatedAt: '2025-03-05T09:15:00Z'
      }
    ];
            ...
            <div className="mb-4">
              <div className="flex gap-2 mb-4">
                <input
                  ...
                  onKeyDown={(e: any) => e.key === 'Enter' && getRecommendations()}
                />
