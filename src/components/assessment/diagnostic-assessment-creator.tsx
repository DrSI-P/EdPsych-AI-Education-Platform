...
export function DiagnosticAssessmentCreator({
  ...
  const renderKnowledgeAreasTab = (): void => {
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e: any) => handleMetadataChange({
                  ...(assessment.metadata || {}),
...
function QuestionEditor({
  ...
  const renderQuestionOptions = (): void => {
          ...
          <div className="space-y-3 mt-4">
            ...
            {question.options?.map((option, i) => (
              <div key={i} className="flex items-center space-x-2">
                <Input
                  value={option}
                  onChange={(e: any) => handleOptionChange(i, e.target.value)}
        ...
        return (
          <div className="mt-4">
            ...
            <Textarea
              ...
              value={question.correctAnswer as string || ''}
              onChange={(e: any) => handleCorrectAnswerChange(e.target.value)}
