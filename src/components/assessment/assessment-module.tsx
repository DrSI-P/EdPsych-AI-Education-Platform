          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-4 md:w-1/2">
              ...
              <Select
                ...
                onChange={(e: any) => setSelectedAgeRange(e.target.value)}
                options={[
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="md:col-span-2">
                        <Textarea
                          label="Question Text"
                          value={question.text}
                          onChange={(e: any) => handleQuestionTextChange(questionIndex, e.target.value)}
                          rows={2}
                          required
                        />
                      </div>
                      ...
                      <Select
                        label="Question Type"
                        value={question.type}
                        onChange={(e: any) => handleQuestionTypeChange(questionIndex, e.target.value)}
                        options={[
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handlePointsChange(questionIndex, e.target.value)}
                      />
                    </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {question.options.map((option, optionIndex) => (
                          <div key={optionIndex} className="flex items-center gap-2">
                            <Input
                              value={option}
                              onChange={(e: any) => handleOptionChange(questionIndex, optionIndex, e.target.value)}
                    ...
                    {(question.type === 'short_answer') && (
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e: any) => handleCorrectAnswerChange(questionIndex, e.target.value)}
