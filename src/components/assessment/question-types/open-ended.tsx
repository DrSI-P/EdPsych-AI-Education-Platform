    ...
    <div className="space-y-6 p-4 bg-white rounded-lg border">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <input
            ...
            min="1"
            value={points}
            onChange={(e: any) => setPoints(parseInt(e.target.value) || 1)}
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">
          This will be used for marking guidance and AI-assisted marking. Students will not see this.
        </p>
        <textarea
          id="expected-answer"
          value={expectedAnswer}
          onChange={(e: any) => setExpectedAnswer(e.target.value)}
          placeholder="Enter an expected answer or marking criteria"
          rows={4}
      ...
      <div>
        ...
        <div className="flex items-center">
          <input
            ...
            min="0"
            value={wordLimit}
            onChange={(e: any) => setWordLimit(parseInt(e.target.value) || 0)}
