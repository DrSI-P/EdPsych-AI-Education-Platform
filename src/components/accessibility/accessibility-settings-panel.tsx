 ...
 */
const AccessibilitySettingsPanel = (): void => {
  ...
  const updateSetting = (key, value): void => {
    setSettings(prev => ({
      ...prev,
      [key]: value
    }));
  ...
  const loadProfile = (profileId): void => {
  ...
  const deleteProfile = (profileId): void => {
  ...
  const enableReadingGuide = (color, size): void => {
  ...
  const updateReadingGuidePosition = (e): void => {
  ...
  const disableReadingGuide = (): void => {
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  onChange={(e: any) => updateSetting('lineSpacing', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white text-sm"
                >
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  onChange={(e: any) => updateSetting('letterSpacing', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white text-sm"
                >
                  <option value="tight">Tight</option>
                  <option value="normal">Normal</option>
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e: any) => updateSetting('reduceMotion', e.target.checked)}
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  <input
                    ...
                    onChange={(e: any) => updateSetting('readingGuide', e.target.checked)}
                    className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                  />
                  ...
                  <div className="pl-6 space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e: any) => updateSetting('readingGuideColor', e.target.value)}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e: any) => updateSetting('readingGuideSize', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white text-sm"
                      >
                        <option value="small">Small</option>
                        <option value="medium">Medium</option>
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e: any) => updateSetting('highlightLinks', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e: any) => updateSetting('keyboardNavigation', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
              ...
              <div className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e: any) => updateSetting('autoComplete', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e: any) => updateSetting('voiceInput', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e: any) => updateSetting('autoplayMedia', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e: any) => updateSetting('showCaptions', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e: any) => updateSetting('reduceNotifications', e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
                />
