...
const VoiceInputSystem = (): void => {
  ...
  const updateRecognitionSettings = (): void => {
  ...
  const addPunctuation = (text): void => {
  ...
  const getConfidenceIndicator = (): void => {
    if (confidence >= 80) {
      return 'bg-green-500';
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e: any) => updateSetting('continuous', e.target.checked)}
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e: any) => updateSetting('interimResults', e.target.checked)}
                className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
              />
              <label htmlFor="interimResults" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                Show interim results whilst speaking
              </label>
            </div>
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e: any) => updateSetting('punctuation', e.target.checked)}
                className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
              />
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e: any) => updateSetting('childMode', e.target.checked)}
                className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-gray-600 dark:bg-neutral-700"
              />
            ...
            <div>
              ...
              <select
                ...
                onChange={(e: any) => updateSetting('sensitivity', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: any) => updateSetting('autoStop', parseInt(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white"
              />
