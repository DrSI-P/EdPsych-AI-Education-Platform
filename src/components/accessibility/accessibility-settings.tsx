 ...
 * 
 * A comprehensive accessibility settings panel that allows users to customise
...
export default function AccessibilitySettings() {
  ...
  // Apply settings to document
  const applySettings = (settings): void => {
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Customise your experience to meet your specific needs
        </CardDescription>
      </CardHeader>
      <CardContent>
