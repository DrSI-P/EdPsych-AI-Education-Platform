...
const sampleCPDActivities = [
  {
    ...
    type: "Course",
    provider: "National Center for Excellence in Teaching Mathematics",
    date: "2023-10-15",
    duration: 12,
    points: 12,
    status: "Completed",
...
export default function ProfessionalPortfolio() {
  ...
  const handleProfileUpdate = (e): void => {
    e.preventDefault();
  ...
  const handleVisibilityToggle = (id, section): void => {
