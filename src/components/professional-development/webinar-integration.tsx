...
const SAMPLE_UPCOMING_WEBINARS = [
  ...
  },
  {
    ...
    capacity: 50,
    registered: 43,
    topics: ['Restorative Justice', 'Behavior Management', 'School Culture'],
    level: 'Advanced'
  },
  {
    id: 'web-004',
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                <Input id="topics" placeholder="e.g., SEND, Behavior Management, Assessment" />
              </div>
              <div className="grid grid-cols-1 gap-2">
