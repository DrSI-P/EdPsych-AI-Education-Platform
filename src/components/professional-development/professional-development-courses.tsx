...
const SAMPLE_COURSES = [
  ...
  },
  {
    ...
    description: 'Learn how to implement restorative practices to improve behavior and strengthen school communities.',
...
const SAMPLE_MODULES = [
  ...
  {
    id: 4,
    title: 'Trauma-Informed Behavior Management',
    description: 'Approaches to managing challenging behavior through a trauma-informed lens.',
    duration: '75 minutes',
...
export default function ProfessionalDevelopmentCourses() {
  ...
  const toggleCategory = (categoryId): void => {
  ...
  const toggleDifficulty = (difficultyId): void => {
  ...
  const renderContentTypeIcons = (contentTypes): void => {
                    ...
                    <Card key={course.id} className="overflow-hidden">
                      ...
                      <CardContent>
                        ...
                        <div className="flex items-center justify-between text-sm text-muted-foreground">
                          <div className="flex items-center gap-1">
                            <Users size={14} />
                            <span>{course.enroled} enroled</span>
                          </div>
                          <div className="flex items-center gap-1">
                ...
                <div className="flex flex-col md:flex-row justify-between gap-4">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-1">
                        <Users size={16} />
                        <span>{selectedCourse.enroled} enroled</span>
                      </div>
                      <div className="flex items-center gap-1">
