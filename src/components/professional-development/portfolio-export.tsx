...
const sampleUserProfile = {
  ...
  bio: "Educational Psychologist with 10+ years of experience working with children and young people with special educational needs. Specialising in assessment, intervention, and support for students with learning difficulties.",
  qualifications: [
...
const sampleAchievements = [
  {
    id: 1,
    title: "School-Wide Intervention Programme",
    description: "Developed and implemented a school-wide intervention programme for students with reading difficulties, resulting in a 35% improvement in literacy scores.",
    date: "March 2025",
    type: "Professional",
...
const sampleEvidence = [
  {
    id: 1,
    title: "Intervention Programme Documentation",
...
const sampleReflections = [
  ...
  },
  {
    ...
    content: "Reflecting on my professional development over the past year, including the impact of specialized training in trauma-informed practices. This has significantly changed my approach to behavioural interventions and assessment practices. Areas for future development include advanced therapeutic techniques and supervision skills.",
    date: "January 2025",
...
export default function PortfolioExport() {
  ...
  const handleFieldChange = (field): void => {
    setIncludeContent({
      ...includeContent,
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground mt-1">Editable document format for further customisation</p>
                    </div>
                  </div>
                </div>
