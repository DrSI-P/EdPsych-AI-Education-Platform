...
const mockResources: any[] = [
  {
    ...
    content: `
      ...
      <p>Restorative approaches focus on building and repairing relationships rather than assigning blame and punishment. These approaches help children develop empathy, responsibility, and communication skills whilst strengthening family bonds.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>When conflicts or problems arise, restorative conversations provide a structured way to address the situation whilst maintaining connection and supporting growth.</p>
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: 'Apply what you\'ve learnt to common family situations.',
        content: 'Lesson content would appear here.',
        completed: false,
        estimatedTime: '20 minutes'
      }
            ...
            <CardContent className="space-y-4">
              <div className="prose max-w-none">
                ...
                <p>
                  ...
                  These approaches help children develop empathy, responsibility, and communication skills whilst strengthening family bonds.
                </p>
