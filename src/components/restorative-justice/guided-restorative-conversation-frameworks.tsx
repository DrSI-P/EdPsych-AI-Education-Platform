 ...
 */
const GuidedRestorativeConversationFrameworks = (): void => {
      ...
      steps: [
        ...
        },
        {
          ...
          questions: [
            ...
            "What's one thing you learnt from our circle today?",
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "Finalise the agreement and conclude the session",
          questions: [
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          questions: [
            "Whilst you were away, your teachers and classmates noticed your absence.",
  ...
  const saveCustomFramework = (): void => {
  ...
  const exportFrameworkAsPDF = (): void => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleCustomFrameworkChange('title', e.target.value)}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleCustomFrameworkChange('description', e.target.value)}
                      />
                    </div>
                    <div>
                        ...
                        <CardContent className="space-y-4">
                          <div>
                            ...
                            <Input
                              ...
                              value={step.title}
                              onChange={(e: any) => handleStepChange(stepIndex, 'title', e.target.value)}
                            />
                          </div>
                          <div>
                            ...
                            <Textarea
                              ...
                              onChange={(e: any) => handleStepChange(stepIndex, 'description', e.target.value)}
                            />
                          </div>
                          <div>
                            ...
                            {step.questions.map((question, questionIndex) => (
                              <div key={questionIndex} className="flex items-center space-x-2 mb-2">
                                <Input
                                  ...
                                  value={question}
                                  onChange={(e: any) => handleQuestionChange(stepIndex, questionIndex, e.target.value)}
                                  className="flex-1"
                                />
                                <Button 
                                  variant="ghost" 
