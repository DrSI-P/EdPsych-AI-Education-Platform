 ...
 */
const CircleProcessTemplates = (): void => {
  ...
  const predefinedTemplates = [
      ...
      questions: [
        {
          ...
          items: [
            ...
            "What's something new you've learnt?",
    ...
    },
    {
      ...
      structure: {
        ...
        closingCeremony: "Thank you everyone for your thoughtful contributions. Our collective wisdom has helped us understand this topic more deeply. Let's close our circle by acknowledging what we've learnt together."
      },
      questions: [
        {
        ...
        },
        {
          ...
          items: [
            ...
            "What's one way you might use what you've learnt?",
  ...
  const handleSelectTemplate = (template): void => {
    setSelectedTemplate(template);
    setActiveTab("designer");
  };

  // Handle custom template changes
  const handleCustomTemplateChange = (field, value): void => {
  ...
  const handleStructureChange = (field, value): void => {
    setCustomTemplate(prev => ({
      ...prev,
      structure: {
        ...prev.structure,
  ...
  const addQuestionCategory = (): void => {
    setCustomTemplate(prev => ({
      ...prev,
  ...
  const handleCategoryChange = (index, value): void => {
    setCustomTemplate(prev => {
  ...
  const addQuestion = (categoryIndex): void => {
    setCustomTemplate(prev => {
      const updatedQuestions = [...prev.questions];
  ...
  const handleQuestionChange = (categoryIndex, questionIndex, value): void => {
    setCustomTemplate(prev => {
      const updatedQuestions = [...prev.questions];
  ...
  const removeQuestion = (categoryIndex, questionIndex): void => {
    setCustomTemplate(prev => {
      const updatedQuestions = [...prev.questions];
      const updatedItems = [...updatedQuestions[categoryIndex].items];
  ...
  const removeQuestionCategory = (index): void => {
    setCustomTemplate(prev => {
      const updatedQuestions = [...prev.questions];
  ...
  const handleMaterialChange = (index, value): void => {
    setCustomTemplate(prev => {
  ...
  // Remove a material
  const removeMaterial = (index): void => {
    setCustomTemplate(prev => {
      const updatedMaterials = [...prev.materials];
  ...
  const exportTemplateAsPDF = (): void => {
  ...
  const duplicateTemplate = (template): void => {
    const duplicated = {
      ...template,
      id: `custom-${Date.now()}`,
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleCustomTemplateChange('title', e.target.value)}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleCustomTemplateChange('description', e.target.value)}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleCustomTemplateChange('timeRequired', e.target.value)}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleCustomTemplateChange('spaceSetup', e.target.value)}
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e: any) => handleStructureChange('openingCeremony', e.target.value)}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e: any) => handleStructureChange('checkIn', e.target.value)}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e: any) => handleStructureChange('mainActivity', e.target.value)}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e: any) => handleStructureChange('checkOut', e.target.value)}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e: any) => handleStructureChange('closingCeremony', e.target.value)}
                      />
                    </div>
                  </div>
                      ...
                      <Card key={categoryIndex}>
                        <CardHeader className="pb-2">
                          ...
                          <Input
                            ...
                            onChange={(e: any) => handleCategoryChange(categoryIndex, e.target.value)}
                          />
                        </CardHeader>
                          ...
                          {category.items.map((question, questionIndex) => (
                            <div key={questionIndex} className="flex items-center space-x-2">
                              <Input
                                ...
                                value={question}
                                onChange={(e: any) => handleQuestionChange(categoryIndex, questionIndex, e.target.value)}
                                className="flex-1"
                              />
                              <Button 
                                variant="ghost" 
                    ...
                    {customTemplate.materials.map((material, index) => (
                      <div key={index} className="flex items-center space-x-2">
                        <Input
                          ...
                          value={material}
                          onChange={(e: any) => handleMaterialChange(index, e.target.value)}
                          className="flex-1"
                        />
                        <Button 
                          variant="ghost" 
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Card>
                          ...
                          <CardContent>
                            <p className="text-sm">
                              A special object passed around the circle that gives the holder the right to speak whilst 
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-4">
                        Whilst circles can be adapted for different purposes, they typically follow this general structure:
                      </p>
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="ml-4">
                              ...
                              <p className="text-sm text-muted-foreground">
                                ...
                                circle experience. This helps bring plenary to the process.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start">
