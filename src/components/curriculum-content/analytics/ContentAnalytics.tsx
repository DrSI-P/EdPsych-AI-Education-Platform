            ...
            <TabsContent value="performance">
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {analyticsData.performance.topPerformingContent.map((content: unknown, index: number) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {analyticsData.performance.underperformingContent.map((content: unknown) => (
                        <Card key={content.id} className="border-l-4 border-l-red-500">
                          <CardContent className="p-4">
                            ...
                            {analyticsData.performance.improvementSuggestions
                              .filter((suggestion: unknown) => suggestion.contentId === content.id)
