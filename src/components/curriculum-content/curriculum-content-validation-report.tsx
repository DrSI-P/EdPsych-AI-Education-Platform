              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      All learning style variants maintain consistent learning objectives whilst adapting presentation.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Content adapts to different learning styles whilst maintaining consistent learning objectives.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Implementation supports student choice of content whilst minimizing learning gaps.
                </p>
              </div>
            </div>
