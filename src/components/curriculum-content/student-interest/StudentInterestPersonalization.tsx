 ...
 * with features for theme customisation, interest-based examples, and engagement optimization.
 */
export function StudentInterestPersonalization() {
  ...
  const handleEngagementSettingUpdate = (key: string, value: unknown) => {
        ...
        <CardContent>
          ...
          <div className="bg-muted/50 p-4 rounded-lg mb-6">
            ...
            <p className="text-sm mb-4">
              Select interest areas to personalize content for students. These interests will be used to customise
          ...
          <Tabs defaultValue="themes" value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="themes">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Customise content themes based on student interests. Themes affect the overall context,
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        id="themeName"
                        value={newThemeName}
                        onChange={(e: any) => setNewThemeName(e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea 
                        ...
                        onChange={(e: any) => setNewThemeDescription(e.target.value)}
            ...
            <TabsContent value="examples">
              <div className="space-y-4">
                <h3 className="text-lg font-medium">Example Customisation</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Customise examples and scenarios based on student interests. Examples are used to illustrate
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e: any) => setNewExampleTitle(e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea 
                        ...
                        onChange={(e: any) => setNewExampleDescription(e.target.value)}
