...
export function CurriculumContentEditor({ 
  ...
  const handleVariantChange = (style: LearningStyle, key: keyof ContentVariant, value: unknown) => {
    setVariants(prev => ({
      ...prev,
      [style]: {
        ...prev[style],
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e: any) => handleVariantChange(LearningStyle.VISUAL, 'content', e.target.value)}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e: any) => handleVariantChange(LearningStyle.AUDITORY, 'content', e.target.value)}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e: any) => handleVariantChange(LearningStyle.KINESTHETIC, 'content', e.target.value)}
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e: any) => handleVariantChange(LearningStyle.READ_WRITE, 'content', e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="grid gap-1.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Organised text information in list format
                      </p>
                    </div>
                  </div>
