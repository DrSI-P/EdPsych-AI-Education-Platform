...
export function LearningStyleAdaptation() {
  ...
  const handleAdaptationUpdate = (style: string, key: string, value: unknown) => {
    setAdaptations(prev => ({
      ...prev,
      [style]: {
        ...prev[style],
  ...
  const handleSaveAdaptations = (): void => {
  ...
  const handleGenerateAdaptations = (): void => {
  ...
  const handlePreviewAdaptations = (): void => {
        ...
        <CardContent>
          ...
          <div className="bg-muted/50 p-4 rounded-lg mb-6">
            ...
            <p className="text-sm mb-4">
              ...
              Enable or disable adaptations for each learning style and customise the settings as needed.
            </p>
          ...
          <Tabs defaultValue="visual" value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="visual">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Customise how content is adapted for visual learners. Visual learners prefer to see information
            ...
            <TabsContent value="auditory">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Customise how content is adapted for auditory learners. Auditory learners prefer to hear information
            ...
            <TabsContent value="kinesthetic">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Customise how content is adapted for kinesthetic learners. Kinesthetic learners prefer to learn by doing
            ...
            <TabsContent value="readingWriting">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Customise how content is adapted for reading/writing learners. These learners prefer to learn through
