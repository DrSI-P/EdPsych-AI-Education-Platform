...
export function EnhancedCurriculumContentCreator({
  ...
  const handleMetadataChange = (key: keyof ContentMetadata, value: unknown) => {
    setMetadata(prev => ({
      ...prev,
      [key]: value
    }));
  ...
  const handleSave = async (status?: ContentStatus) => {
    try {
      ...
      toast({
        ...
        description: "An error occurred whilst saving your content. Please try again.",
        variant: "destructive"
      });
      setLoading(false);
      setSaveProgress(0);
  ...
  const renderContentPreview = (): void => {
  ...
  const renderContentEditor = (): void => {
    const variant = variants[selectedLearningStyle];
          ...
          <div>
            ...
            <div className="flex mt-1.5">
              <Input
                id="mediaUrls"
                value={mediaUrlInput}
                onChange={(e: any) => setMediaUrlInput(e.target.value)}
  ...
  return (
    <div className="container mx-auto py-6">
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e: any) => handleMetadataChange('title', e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e: any) => handleMetadataChange('description', e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e: any) => handleMetadataChange('estimatedDuration', parseInt(e.target.value))}
                      min={1}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex mt-1.5">
                      <Input
                        ...
                        onChange={(e: any) => setObjectiveInput(e.target.value)}
      ...
      {/* Template Dialogue */}
      <Dialogue open={showTemplateDialog} onOpenChange={setShowTemplateDialog}>
      ...
      <Dialogue open={showCollaboratorsDialog} onOpenChange={setShowCollaboratorsDialog}>
      ...
      {/* Version History Dialogue */}
      <Dialogue open={showVersionHistoryDialog} onOpenChange={setShowVersionHistoryDialog}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
      ...
      {/* Help Dialogue */}
      <Dialogue open={showHelpDialog} onOpenChange={setShowHelpDialog}>
