...
export function ContentVersionControl() {
  ...
  const handleApproveContent = (): void => {
  ...
  const handlePublishContent = (): void => {
  ...
  const handleRejectContent = (): void => {
