...
export function UKCurriculumAlignment() {
  ...
  const handleAddInterestTag = (): void => {
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-600 mt-1">
                        ...
                        You'll be able to customise each variant whilst maintaining alignment with curriculum objectives.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <Input 
                      ...
                      onChange={(e: any) => setNewInterestTag(e.target.value)}
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-600 mt-1">
                        ...
                        The system will use these tags to create personalized learning experiences whilst
