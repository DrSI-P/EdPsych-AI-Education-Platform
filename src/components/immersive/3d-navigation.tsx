...
export function ThreeDScene({
  ...
  onSceneLoaded,
  onSceneError,
}: ThreeDSceneProps): React.ReactNode {
  ...
  return (
    <div
      className={`three-d-scene relative w-full h-full overflow-hidden ${className}`}
    >
      {/* Loading overlay */}
      {isLoading && (
        <div className="absolute inset-0 flex items-centre justify-centre bg-grey-900/50 z-20">
          <div className="text-centre text-white">
            <div
              className="inline-block h-12 w-12 animate-spin rounded-full border-4 border-solid border-white border-r-transparent align-[-0.125em]"
              role="status"
            >
        ...
        >
          ...
          >
            {isFullscreen ? (
              <path
                fillRule="evenodd"
                d="M5 4a1 1 0 00-1 1v4a1 1 0 01-2 0V5a3 3 0 013-3h4a1 1 0 010 2H5zm10 8a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 010-2h4a1 1 0 001-1v-4a1 1 0 012 0zm-10 0a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 000-2H5a1 1 0 01-1-1v-4a1 1 0 00-2 0z"
                clipRule="evenodd"
              />
            ) : (
              <path
