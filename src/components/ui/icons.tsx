...
import {
  ...
  Rss as LucideRss,
  Share as LucideShare3,
  Wifi as LucideWifi2,
  Bluetooth as LucideBluetooth2,
  Cast as LucideCast,
  Airplay as LucideAirplay,
  Smartphone as LucideSmartphone2,
  Tablet as LucideTablet2,
  Laptop as LucideLaptop2,
  Monitor as LucideMonitor2,
  Tv as LucideTv2,
  Speaker as LucideSpeaker2,
  Headphones as LucideHeadphones2,
  Music as LucideMusic2,
  Video as LucideVideo2,
  Camera as LucideCamera2,
  Film as LucideFilm2,
  Image as LucideImage2,
  Aperture as LucideAperture,
  Sunrise as LucideSunrise,
  Sunset as LucideSunset,
  Sun as LucideSun2,
  Moon as LucideMoon2,
  Cloud as LucideCloud2,
  CloudRain as LucideCloudRain2,
  CloudSnow as LucideCloudSnow2,
  CloudLightning as LucideCloudLightning2,
  CloudDrizzle as LucideCloudDrizzle,
  CloudOff as LucideCloudOff,
  Thermometer as LucideThermometer2,
  Umbrella as LucideUmbrella2,
  Wind as LucideWind2,
  Compass as LucideCompass2,
  Navigation as LucideNavigation,
  Navigation2 as LucideNavigation2,
  Map as LucideMap2,
  MapPin as LucideMapPin2,
  Globe as LucideGlobe2,
  Flag as LucideFlag2,
  Home as LucideHome2,
  Building as LucideBuilding,
  Landmark as LucideLandmark,
  Briefcase as LucideBriefcase,
  Clipboard as LucideClipboard2,
  Clipboard as LucideClipboard3,
  Clipboard as LucideClipboard4,
  Clipboard as LucideClipboard5,
  Clipboard as LucideClipboard6,
  Clipboard as LucideClipboard7,
  Clipboard as LucideClipboard8,
  Clipboard as LucideClipboard9,
  Clipboard as LucideClipboard10,
} from "lucide-react";
