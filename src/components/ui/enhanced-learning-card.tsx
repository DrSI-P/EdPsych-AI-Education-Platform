...
const EnhancedLearningCard: React.FC<LearningCardProps> = ({
  ...
  const getLearningStyleIndicator = (): void => {
    ...
    return (
      <div className={`inline-flex items-center text-xs font-medium px-2 py-1 rounded-full mb-2 ${style.className}`}>
        {style.icon}
        {style.label}
      </div>
    );
