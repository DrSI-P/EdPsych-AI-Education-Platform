...
export function CardImage({ src, alt, className = '' }: CardImageProps): React.ReactNode {
  return (
...
export function CardActions({ children, className = '' }: CardActionsProps): React.ReactNode {
  return (
