 ...
 * 
 * An AI-enhanced navigation bar that adapts to user behavior,
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span>{item.name}</span>
                  {item.isPredicted && (
                    <Badge variant="outline" className="absolute -top-2 -right-2 h-4 w-4 p-0 flex items-center justify-center">
