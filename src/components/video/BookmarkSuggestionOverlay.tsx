...
const BookmarkSuggestionOverlay: React.FC<BookmarkSuggestionOverlayProps> = ({
  ...
  return (
    <div 
      className={`absolute bottom-20 right-4 bg-gray-900/90 rounded-lg shadow-lg transition-all duration-300 ${
      ...
      <div className="p-3">
        <div className="flex items-start justify-between">
          ...
          <div className="relative">
            ...
            {showReasonTooltip && (
              <div className="absolute bottom-full right-0 mb-2 p-2 bg-gray-800 rounded text-xs text-white w-48 z-10">
