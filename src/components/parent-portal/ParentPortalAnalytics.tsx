...
export function ParentPortalAnalytics() {
  ...
  const renderProgressBar = (value, color = 'blue', label = ''): void => {
    return (
  ...
  const renderLineChart = (data, labels, height = 100, color = 'blue'): void => {
  ...
  const renderBarChart = (data, labels, height = 150, color = 'blue'): void => {
    const max = Math.max(...data) * 1.1;
  ...
  const renderPieChart = (data, labels, colors, size = 150): void => {
                ...
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    ...
                    <div className="p-3 border border-amber-200 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-800 rounded-md">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        {t('writing_structure_description', TranslationNamespace.PARENT_TEACHER, { default: 'Alex would benefit from more practice in organising ideas in written work. Focus on paragraph structure and using connecting words to link ideas.' })}
                      </p>
                    </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                          ...
                          <ul className="text-sm text-gray-600 dark:text-gray-400 list-disc list-inside">
                            ...
                            <li>{t('mind_maps', TranslationNamespace.PARENT_TEACHER, { default: 'Create mind maps to organise information' })}</li>
                          </ul>
                        </div>
                      </div>
                    </div>
