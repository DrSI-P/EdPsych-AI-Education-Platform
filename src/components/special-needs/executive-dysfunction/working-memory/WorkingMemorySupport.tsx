...
export default function WorkingMemorySupport() {
  ...
  // Complete exercise
  const handleCompleteExercise = (result: unknown) => {
  ...
  const renderExerciseComponent = (): void => {
  ...
  const renderToolComponent = (): void => {
  ...
  const renderExercisesList = (): void => {
          ...
          <div className="space-y-6">
            <div>
              ...
              <Select
                ...
                onChange={(e: any) => handleUpdateConfig('defaultSupportLevel', e.target.value)}
                className="w-full"
              >
            ...
            <div>
              ...
              <Select
                ...
                onChange={(e: any) => handleUpdateConfig('notificationFrequency', e.target.value)}
                className="w-full"
              >
