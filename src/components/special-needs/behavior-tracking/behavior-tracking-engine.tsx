...
const BehaviorTrackingEngine = (): void => {
  ...
  const getBehaviorCategoryColor = (category): void => {
    switch (category) {
      case 'positive':
  ...
  const getGoalStatusColor = (status): void => {
    switch (status) {
      case 'active':
        return 'bg-blue-100 text-blue-800';
      case 'completed':
  ...
  const getRewardCategoryColor = (category): void => {
    switch (category) {
      case 'privilege':
  ...
  const calculateGoalProgress = (goal): void => {
        ...
        <TabsContent value="track" className="space-y-6">
                ...
                <form onSubmit={handleTrackingSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setTrackingForm({...trackingForm, count: parseInt(e.target.value)})}
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      type="text" 
                      id="context" 
                      placeholder="e.g., During maths lesson"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Visualise behavior patterns over time to identify trends and progress.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {trackingData.length > 0 ? (
                ...
                <form onSubmit={handleBehaviorSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setNewBehavior({...newBehavior, pointValue: parseInt(e.target.value)})}
                    />
                ...
                <form onSubmit={handleGoalSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setNewGoal({...newGoal, targetValue: parseInt(e.target.value)})}
                      required
                    />
                ...
                <form onSubmit={handleRewardSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setNewReward({...newReward, pointCost: parseInt(e.target.value)})}
                      required
                    />
