...
const PersonalizedStrategyRecommendations = (): void => {
  ...
  const regulationStrategies = [
    ...
    },
    {
      ...
      complexity: "moderate",
      duration: "short",
      evidenceBase: "Based on mindfulness practices recommended by the Oxford Mindfulness Center and NICE guidelines."
    },
    {
    ...
    try {
      ...
      const mockStrategyHistory = [
        ...
        },
        {
          ...
          effectiveness: 3,
          timestamp: new Date(Date.now() - 86400000).toISOString(),
          notes: "Took a whilst but eventually helped me focus"
        },
        {
          id: "strategy-use-3",
          strategyId: "counting",
  ...
  const generatePersonalizedRecommendations = async (): void => {
  ...
  const handleCurrentMoodSelect = (emotion): void => {
  ...
  const handleFavoriteStrategy = (strategyId): void => {
  ...
  const getReasonIcon = (reasonType): void => {
    switch (reasonType) {
      case 'effectiveness':
