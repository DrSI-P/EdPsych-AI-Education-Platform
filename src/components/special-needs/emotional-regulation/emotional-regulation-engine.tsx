...
export function EmotionalRegulationEngine() {
  ...
  const handleEmotionSelect = (emotion): void => {
    setCurrentEmotion({
      ...currentEmotion,
      name: emotion.name
    });
  ...
  const handleIntensityChange = (value): void => {
    setCurrentEmotion({
      ...currentEmotion,
      intensity: value[0]
    });
  ...
  const handleBodyFeelingToggle = (feeling): void => {
  ...
  // Get intensity color
  const getIntensityColor = (intensity): void => {
  ...
  const getDifficultyColor = (difficulty): void => {
    switch (difficulty) {
