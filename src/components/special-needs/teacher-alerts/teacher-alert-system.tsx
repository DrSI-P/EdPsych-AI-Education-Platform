...
const TeacherAlertSystem = (): void => {
  ...
  const mockAlerts = [
    { 
      ...
      recommendations: ["Timetable check-in before mathematics", "Offer alternative seating options"]
    },
    { 
      id: "a2", 
      studentId: "s3", 
    ...
    { 
      ...
      recommendations: ["Provide visual timetable for transitions", "Implement transition warnings"]
    },
    { 
      id: "a4", 
      studentId: "s7", 
      ...
      recommendations: ["Implement reading accommodations from IEP", "Timetable reading intervention sessions"]
    },
    { 
      id: "a5", 
      studentId: "s1", 
  ...
  const mockAbccRecords = [
    ...
    },
    {
      ...
      communication: "Visual timetable reviewed, reminder of expectations provided",
      intensity: "high",
      duration: "5 minutes",
    ...
    },
    {
      ...
      communication: "Gentle encouragement to join morning activities, reminder of day's timetable",
      intensity: "medium",
      duration: "20 minutes",
    ...
    },
    {
      ...
      consequence: "Tutor checked in, student declined support",
  ...
  const getSeverityBadge = (severity): void => {
    switch (severity) {
      case 'low':
  ...
  const getStatusBadge = (status): void => {
    switch (status) {
      case 'new':
  ...
  const getIntensityBadge = (intensity): void => {
    switch (intensity) {
      case 'low':
        return <Badge variant="outline" className="bg-blue-50 text-blue-700">Low</Badge>;
      case 'medium':
  ...
  const getFilteredAbccRecords = (): void => {
  ...
  const getAlertsBySeverity = (): void => {
    const counts = {
      low: 0,
      medium: 0,
      high: 0
  ...
  const getStudentsWithMostAlerts = (): void => {
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea 
                              ...
                              onChange={(e: any) => setNewAbccRecord({...newAbccRecord, behavior: e.target.value})}
                              className="min-h-[80px]"
                            />
                          </div>
