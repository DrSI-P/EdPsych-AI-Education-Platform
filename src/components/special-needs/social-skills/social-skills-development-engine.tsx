...
const SocialSkillsDevelopmentEngine = (): void => {
  ...
  const prepareProgressChartData = (): void => {
  ...
  const getSkillCategoryColor = (category): void => {
    switch (category) {
      case 'communication':
  ...
  const getDifficultyLevelColor = (level): void => {
    switch (level) {
      case 'beginner':
        return 'bg-green-100 text-green-800';
      case 'intermediate':
  ...
  const getActivityTypeColor = (type): void => {
    switch (type) {
      case 'group':
        return 'bg-blue-100 text-blue-800';
      case 'pair':
                ...
                <form onSubmit={handleActivitySubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e: any) => setNewActivity({...newActivity, duration: parseInt(e.target.value)})}
                      required
                    />
                  </div>
                ...
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    <p className="text-sm">
                      ...
                      modelling as an evidence-based practice for teaching social skills.
                    </p>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1">
                    Video modelling is an evidence-based practice identified by the National Professional Development Center 
