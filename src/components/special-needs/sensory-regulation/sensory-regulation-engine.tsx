  ...
  const sampleActivities: any[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        'Focus on breathing whilst watching'
      ],
      benefits: [
                        ...
                        <Button 
                          ...
                          onClick={(e: any) => {
                            ...
                            toast({
                              ...
                              description: `${activity.name} has been added to your timetable.`,
                            });
                          }}
                        >
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customise sensory regulation tools and preferences
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="scheduleReminders">Timetable Reminders</Label>
                      <p className="text-xs text-muted-foreground">
