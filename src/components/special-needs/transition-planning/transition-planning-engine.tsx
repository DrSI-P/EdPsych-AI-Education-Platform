...
const TransitionPlanningEngine = (): void => {
  ...
  const handleRemoveStep = (index): void => {
    setNewGoal(prev => ({
      ...prev,
  ...
  const handleRemoveResource = (id): void => {
    setTransitionPlan(prev => ({
      ...prev,
  ...
  const getTransitionTypeIcon = (type): void => {
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            <Input
                              ...
                              value={newStep}
                              onChange={(e: any) => setNewStep(e.target.value)}
                              className="w-64"
                            />
                            <Button 
                              type="button" 
