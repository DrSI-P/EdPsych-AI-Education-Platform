...
// Main component
const CopyrightRegistrationTools = (): void => {
  ...
  const copyVerificationLink = (id): void => {
  ...
  const renderCopyrightCard = (registration): void => {
  ...
  const LicenseInfo = ({ licenseType }): void => {
    const licence = licenseTypes.find(l => l.id === licenseType) || {
      name: licenseType,
      description: 'Custom licence type'
    };
    
    const getLicenseIcon = (type): void => {
              ...
              <div className="grid gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      Learn more about licence types
                    </Button>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="md:col-span-3">
                        ...
                        <Input
                          ...
                          onChange={(e: any) => setVerificationId(e.target.value)}
                        />
                      </div>
          ...
          <div className="py-4 max-h-[60vh] overflow-y-auto pr-2">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                When selecting a licence for your educational content, consider:
              </p>
...
const ResourceCopyrightRegistration = ({ resource, onRegister }): void => {
  ...
  return (
    <div className="space-y-4 py-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Select the appropriate licence for your resource
        </p>
      </div>
...
const AIContentCopyrightRegistration = ({ content, onRegister }): void => {
  const [isRegistering, setIsRegistering] = useState(false);
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700">
              This content was generated using AI. Whilst you can register copyright for your prompt and the resulting content, there may be limitations on copyright protection for purely AI-generated works.
            </p>
          </div>
        </div>
      </div>
