...
export const PushNotificationManager: React.FC<PushNotificationManagerProps> = ({
  ...
  const dismissPermissionPrompt = (): void => {
    setShowPermissionPrompt(false);
  };
            ...
            <div className="channel-header">
              ...
              <label className="toggle-switch">
                <input
                  ...
                  onChange={(e: any) => updateChannelPreference(channel, 'enabled', e.target.checked)}
                />
                ...
                <div className="setting-item">
                  <label>
                    <input
                      ...
                      onChange={(e: any) => updateChannelPreference(channel, 'pushEnabled', e.target.checked)}
                    />
                    Push Notifications
                  </label>
                </div>
                ...
                <div className="setting-item">
                  <label>
                    <input
                      ...
                      onChange={(e: any) => updateChannelPreference(channel, 'emailEnabled', e.target.checked)}
                    />
                    Email Notifications
                  </label>
                </div>
                ...
                <div className="setting-item">
                  <label>
                    <input
                      ...
                      onChange={(e: any) => updateChannelPreference(channel, 'inAppEnabled', e.target.checked)}
                    />
                ...
                <div className="setting-item">
                  <label>
                    <input
                      ...
                      onChange={(e: any) => updateChannelPreference(channel, 'quietHoursEnabled', e.target.checked)}
                    />
                    Quiet Hours
                  </label>
                </div>
                  ...
                  <div className="quiet-hours-settings">
                    <div className="time-setting">
                      ...
                      <input
                        ...
                        onChange={(e: any) => updateChannelPreference(channel, 'quietHoursStart', e.target.value)}
                      />
                    </div>
                    ...
                    <div className="time-setting">
                      ...
                      <input
                        ...
                        onChange={(e: any) => updateChannelPreference(channel, 'quietHoursEnd', e.target.value)}
                      />
                    </div>
                  </div>
                )}
            ...
            <div className="device-header">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={settings.enabled}
                  onChange={(e: any) => updateDevicePreference(deviceId, e.target.checked)}
                />
                <span className="toggle-slider"></span>
              </label>
            </div>
...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({
  ...
  const handleNotificationClick = (notification): void => {
    // Mark as read
