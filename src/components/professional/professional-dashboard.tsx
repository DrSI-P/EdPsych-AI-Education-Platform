...
export function ProfessionalDashboard({
  ...
  const [professionalData, setProfessionalData] = useState({
    ...
    organization: 'Oakwood Educational Services',
    caseload: [
      {
        id: '1',
        name: 'Emma Thompson',
      ...
      },
      {
        ...
        concerns: ['Exam stress', 'Organization skills'],
        notes: 'Sophia is experiencing increased anxiety about upcoming GCSEs. Working on organization strategies and stress management techniques.'
      },
      {
        id: '4',
        name: 'James Wilson',
    ...
    resources: [
      ...
      },
      {
        ...
        type: 'assessment',
        targetAreas: ['Organization', 'Planning', 'Working memory'],
        ageRange: '14-16',
            ...
            <>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{professionalData.role} • {professionalData.organization}</p>
                </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-green-600 mb-1">
                        {professionalData.timetable.filter(item => 
