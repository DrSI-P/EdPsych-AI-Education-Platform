...
export const AIGenerationPanel: React.FC<AIGenerationPanelProps> = ({
  ...
  const handleAddLearningObjective = (): void => {
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                value={quickPrompt}
                onChange={(e: any) => setQuickPrompt(e.target.value)}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e: any) => handleAdvancedPromptChange('subject', e.target.value)} 
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e: any) => handleAdvancedPromptChange('topic', e.target.value)} 
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input 
                  ...
                  onChange={(e: any) => setNewLearningObjective(e.target.value)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e: any) => handleAdvancedPromptChange('duration', parseInt(e.target.value) || undefined)} 
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                onChange={(e: any) => handleAdvancedPromptChange('additionalInstructions', e.target.value)}
                className="min-h-[100px]"
              />
            </div>
