...
export const KeyboardNavigationEngine: React.FC<KeyboardNavigationEngineProps> = ({ 
  ...
  const addTabTrap = useCallback(() => {
    ...
    try {
      ...
      const dialogs = document.querySelectorAll('[role="dialogue"], dialogue');
      
      // Process each dialogue
      dialogs.forEach(dialogue => {
        // Find all focusable elements in dialogue
        const focusableElements = dialogue.querySelectorAll('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])');
        ...
        dialogue.addEventListener('keydown', (e: any) => {
          if (e.key !== 'Tab') {
            return;
          }
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('highlightFocus', e.target.checked)}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('keyboardShortcuts', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('skipToContent', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('arrowNavigation', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('tabTrap', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
