          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e: any) => handleSettingToggle('enabled', e.target.checked)}
                className="toggle"
              />
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingToggle('contrastLevel', parseInt(e.target.value))}
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingToggle('boldText', e.target.checked)}
                    disabled={!settings.enabled}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingToggle('largerText', e.target.checked)}
                    disabled={!settings.enabled}
                    className="toggle toggle-sm"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingToggle('highlightLinks', e.target.checked)}
                    disabled={!settings.enabled}
                    className="toggle toggle-sm"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingToggle('highlightButtons', e.target.checked)}
                    disabled={!settings.enabled}
                    className="toggle toggle-sm"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingToggle('customColors', e.target.checked)}
                    disabled={!settings.enabled}
                    className="toggle toggle-sm"
                  />
                </div>
