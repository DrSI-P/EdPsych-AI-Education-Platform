            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('dimBackground', e.target.checked)}
              ...
              {settings.dimBackground && (
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingChange('dimLevel', parseInt(e.target.value, 10))}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('highlightFocusedContent', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('highlightColor', e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('focusTimer', parseInt(e.target.value, 10))}
                  disabled={!settings.enabled}
                  className="w-full"
                />
                ...
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('blockNotifications', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('hideNonEssentialElements', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('autoScrollToActive', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('breakReminders', e.target.checked)}
