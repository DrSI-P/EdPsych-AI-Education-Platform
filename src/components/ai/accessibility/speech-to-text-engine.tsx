            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('autoCapitalization', e.target.checked)}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('punctuationPrediction', e.target.checked)}
                  disabled={!settings.enabled || !recognitionSupported}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('childVoiceOptimization', e.target.checked)}
                  disabled={!settings.enabled || !recognitionSupported}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('continuousListening', e.target.checked)}
                  disabled={!settings.enabled || !recognitionSupported}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('interimResults', e.target.checked)}
                  disabled={!settings.enabled || !recognitionSupported}
                  className="toggle toggle-sm"
                />
              </div>
