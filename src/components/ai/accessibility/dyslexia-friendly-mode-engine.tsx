            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('fontSize', parseInt(e.target.value, 10))}
                  disabled={!settings.enabled}
                  className="w-full"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('lineSpacing', parseInt(e.target.value, 10))}
                  disabled={!settings.enabled}
                  className="w-full"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('letterSpacing', parseFloat(e.target.value))}
                  disabled={!settings.enabled}
                  className="w-full"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('useCustomColors', e.target.checked)}
                  disabled={!settings.enabled}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={(e: any) => handleSettingChange('backgroundColor', e.target.value)}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={(e: any) => handleSettingChange('textColor', e.target.value)}
                        disabled={!settings.enabled || !settings.useCustomColors}
                        className="w-8 h-8 rounded-md"
                      />
                ...
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('highlightHeaders', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('simplifyLayout', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('useRuler', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                    ...
                    <>
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e: any) => handleSettingChange('rulerHeight', parseInt(e.target.value, 10))}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('useSyllableHighlighting', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
