            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={settings.type}
                  onChange={(e: any) => handleSettingChange('type', e.target.value)}
              ...
              {settings.type === 'custom' && (
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e: any) => handleSettingChange('customFilter', e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('intensity', parseInt(e.target.value, 10))}
                  disabled={!settings.enabled}
                  className="w-full"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('applyToImages', e.target.checked)}
                  disabled={!settings.enabled}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('applyToVideos', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
                ...
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('highlightLinks', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('highlightButtons', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('enhanceContrast', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  {settings.enhanceContrast && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e: any) => handleSettingChange('contrastLevel', parseInt(e.target.value, 10))}
