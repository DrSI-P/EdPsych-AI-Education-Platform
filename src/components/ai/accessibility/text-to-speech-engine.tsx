            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  step="0.1"
                  value={settings.rate}
                  onChange={(e: any) => handleSettingChange('rate', parseFloat(e.target.value))}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('pitch', parseFloat(e.target.value))}
                  disabled={!settings.enabled || !speechSupported}
                  className="w-full"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('volume', parseFloat(e.target.value))}
                  disabled={!settings.enabled || !speechSupported}
                  className="w-full"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('useUKVoice', e.target.checked)}
                  disabled={!settings.enabled || !speechSupported}
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="highlight-text" className="flex items-center text-sm">
                  Highlight Text Whilst Speaking
                </Label>
                <input
                  type="checkbox"
                  id="highlight-text"
                  checked={settings.highlightText}
                  onChange={(e: any) => handleSettingChange('highlightText', e.target.checked)}
                  disabled={!settings.enabled || !speechSupported}
                  className="toggle toggle-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="auto-scroll" className="flex items-center text-sm">
                  Auto-Scroll Whilst Speaking
                </Label>
                <input
                  type="checkbox"
                  id="auto-scroll"
                  checked={settings.autoScroll}
                  onChange={(e: any) => handleSettingChange('autoScroll', e.target.checked)}
                  disabled={!settings.enabled || !speechSupported}
                  className="toggle toggle-sm"
                />
              </div>
