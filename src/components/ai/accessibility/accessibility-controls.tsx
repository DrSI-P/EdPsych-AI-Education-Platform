    ...
    <div className="accessibility-controls">
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
            Customise accessibility settings to improve your experience
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <input
                ...
                onChange={(e: any) => handleSettingChange('enabled', e.target.checked)}
                className="checkbox"
              />
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('screenReaderOptimization', e.target.checked)}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('highContrastMode', e.target.checked)}
                  disabled={!settings.enabled}
                  className="checkbox checkbox-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('textToSpeech', e.target.checked)}
                  disabled={!settings.enabled}
                  className="checkbox checkbox-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('speechToText', e.target.checked)}
                  disabled={!settings.enabled}
                  className="checkbox checkbox-sm"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('keyboardNavigation', e.target.checked)}
                  disabled={!settings.enabled}
                  className="checkbox checkbox-sm"
                />
              </div>
                ...
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('reducedMotion', e.target.checked)}
                      disabled={!settings.enabled}
                      className="checkbox checkbox-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('dyslexiaFriendlyMode', e.target.checked)}
                      disabled={!settings.enabled}
                      className="checkbox checkbox-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('colorBlindnessMode', e.target.checked)}
                      disabled={!settings.enabled}
                      className="checkbox checkbox-sm"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('focusMode', e.target.checked)}
                      disabled={!settings.enabled}
                      className="checkbox checkbox-sm"
                    />
                  </div>
      ...
      <div className="mt-4">
        ...
        <AlertDescription>
          We are committed to making our platform accessible to all users, regardless of ability or technology. These settings help customise your experience, but we always welcome feedback on how we can improve accessibility further.
        </AlertDescription>
        </Alert>
      </div>
