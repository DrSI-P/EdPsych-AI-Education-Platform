            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('wordsPerMinute', parseInt(e.target.value, 10))}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('showProgressBar', e.target.checked)}
                  disabled={!settings.enabled}
                ...
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('includeImages', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  {settings.includeImages && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e: any) => handleSettingChange('imageTimeValue', parseInt(e.target.value, 10))}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('includeInteractiveElements', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  {settings.includeInteractiveElements && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e: any) => handleSettingChange('interactiveTimeValue', parseInt(e.target.value, 10))}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('adjustForComplexity', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  {settings.adjustForComplexity && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e: any) => handleSettingChange('complexityFactor', parseInt(e.target.value, 10))}
