...
const AIComponents = (): void => {
  ...
  const generateContent = (topic, complexity): void => {
    setIsLoading(true);
  ...
  const updatePreference = (key, value): void => {
  ...
  const completeTask = (taskId): void => {
      ...
      <div className="p-6">
        ...
        {activeTab === 'executive' && (
          <div>
            ...
            <div className="mb-6">
              <h4 className="text-md font-medium text-gray-900 dark:text-white mb-3">Suggested Timetable</h4>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                      <input
                        ...
                        onChange={(e: any) => updatePreference('adaptiveContentEnabled', e.target.checked)}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e: any) => updatePreference('contentComplexity', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white"
                    >
                      <option value="simple">Simple (Ages 5-8)</option>
                      <option value="medium">Medium (Ages 9-12)</option>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e: any) => updatePreference('learningStyle', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white"
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                      <input
                        ...
                        onChange={(e: any) => updatePreference('aiSuggestions', e.target.checked)}
                        className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"
                      />
                      <label
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                      <input
                        ...
                        onChange={(e: any) => updatePreference('contentTransformation', e.target.checked)}
                        className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"
                      />
                      <label
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                      <input
                        ...
                        onChange={(e: any) => updatePreference('emotionalSupport', e.target.checked)}
                        className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"
                      />
                      <label
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                      <input
                        ...
                        onChange={(e: any) => updatePreference('executiveFunctionSupport', e.target.checked)}
                        className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"
                      />
                      <label
