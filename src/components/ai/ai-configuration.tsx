            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e: any) => handleSettingChange('systemPrompt', e.target.value)}
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    onChange={(e: any) => handleSettingChange('temperature', parseFloat(e.target.value))}
                    className="w-full" 
                  />
              ...
              <div>
                ...
                <Input 
                  ...
                  onChange={(e: any) => handleSettingChange('maxTokens', parseInt(e.target.value))}
                  className="w-full"
                />
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    step="0.05" 
                    value={config.topP}
                    onChange={(e: any) => handleSettingChange('topP', parseFloat(e.target.value))}
                    className="w-full" 
                  />
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    onChange={(e: any) => handleSettingChange('frequencyPenalty', parseFloat(e.target.value))}
                    className="w-full" 
                  />
                  <span className="text-sm">2.0</span>
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    onChange={(e: any) => handleSettingChange('presencePenalty', parseFloat(e.target.value))}
                    className="w-full" 
                  />
                  <span className="text-sm">2.0</span>
                </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input 
                  ...
                  onChange={(e: any) => handleNestedConfigChange('usageSettings', 'usageSettings', 'rateLimit', parseInt(e.target.value))}
                  className="w-full"
                />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-4">
                <Alert type="info">
                  <p>Cost optimization is enabled. The system will automatically select the most cost-effective AI provider based on the task requirements.</p>
                </Alert>
              </div>
            </CardContent>
          </Card>
