    ...
    <div className="space-y-4">
      ...
      <div className="pt-2">
        <Button 
          ...
          className="w-full"
        >
          {isProcessing ? 'Analysing...' : 'Analyze My Feedback'}
        </Button>
      </div>
    </div>
  );
        ...
        {!audioURL ? (
          ...
          <div className="w-full">
            ...
            <div className="flex space-x-2">
              ...
              >
                {isProcessing ? 'Analysing...' : 'Analyze Recording'}
              </Button>
            </div>
          </div>
        )}
    ...
    <div className="space-y-4">
      ...
      <div className="pt-2">
        <Button 
          ...
          className="w-full"
        >
          {isProcessing ? 'Analysing...' : 'Save & Analyze Drawing'}
        </Button>
      </div>
    </div>
  );
  
  const renderAnalysisResults = (): void => {
