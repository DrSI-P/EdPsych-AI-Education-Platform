...
export default function TeacherAutomation() {
  ...
  useEffect(() => {
    ...
    const simulateSpeechRecognition = (): void => {
      return {
        start: () => {
  ...
  const generateLessonPlan = async () => {
    ...
    try {
      const prompt = `
        ...
        Mark Level: ${lessonPlanInput.gradeLevel}
  ...
  const generateReport = async () => {
    ...
    try {
      const prompt = `
        ...
        Mark Level: ${reportInput.gradeLevel}
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <Textarea 
          ...
          onChange={handleReportChange} 
          placeholder="Comments on behavior, social skills, emotional regulation, etc."
          className="min-h-[80px]"
        />
      </div>
