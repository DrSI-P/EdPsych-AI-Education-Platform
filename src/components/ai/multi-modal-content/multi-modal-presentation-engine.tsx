...
export default function MultiModalPresentationEngine({
  ...
  const renderInteractiveView = (): void => {
    if (!multiModalContent?.slides) return null;
