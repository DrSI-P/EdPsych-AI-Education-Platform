 ...
 */
const AIAvatarVideoSystem = (): void => {
  ...
  const [videos, setVideos] = useState([
    ...
    },
    {
      ...
      description: 'Tips and strategies for staying organised with schoolwork.',
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e: any) => setFilters({ ...filters, ageGroup: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e: any) => setFilters({ ...filters, subject: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-neutral-700 dark:text-white"
                >
