      ...
      <Card className="w-full">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e: any) => handleSettingChange('adaptationLevel', e.target.value)}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('autoAdjust', e.target.checked)}
                  disabled={!settings.enabled}
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) => handleSettingChange('showComplexityIndicator', e.target.checked)}
                  disabled={!settings.enabled}
                  className="toggle toggle-sm"
                />
              </div>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('learningRateMultiplier', parseFloat(e.target.value))}
                      disabled={!settings.enabled}
                      className="w-full"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('preserveUserProgress', e.target.checked)}
                      disabled={!settings.enabled}
                      className="toggle toggle-sm"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e: any) => handleSettingChange('complexityThreshold', parseInt(e.target.value))}
                      disabled={!settings.enabled}
                      className="w-full"
                    />
                  </div>
            ...
            {isAnalyzing && (
              <div className="space-y-2">
                <div className="flex justify-between text-sm mb-1">
                  <span>Analysing user performance...</span>
        ...
        <CardFooter className="flex flex-col space-y-2">
          <Button 
            ...
            className="w-full"
          >
            {isAnalyzing ? 'Analysing...' : 'Analyze User Performance'}
          </Button>
