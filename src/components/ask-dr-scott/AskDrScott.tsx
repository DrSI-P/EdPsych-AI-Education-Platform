...
export function AskDrScott({ className }: AskDrScottProps) {
  ...
  React.useEffect(() => {
    ...
    // Set the script content to the HeyGen embed code (updated with new share parameters)
  ...
  return (
    <Card className={className} data-feature="ask-dr-scott">
      <CardHeader>
        <CardTitle>Ask Dr. Scott</CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Ask Dr. Scott any questions about educational psychology, learning strategies, or how to use the platform.
        </p>
      </CardContent>
    </Card>
  );
