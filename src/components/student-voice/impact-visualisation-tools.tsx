...
const PieChartComponent = ({ data, title, dataKey = 'value', nameKey = 'name' }): void => {
...
const RadarChartComponent = ({ data, title }): void => {
...
export default function ImpactVisualisationTools() {
  ...
  const impactData = {
    ...
    recentImpacts: [
      ...
      },
      {
        ...
        date: "May 5, 2025",
        impact: "Medium",
        description: "Peer-led anti-bullying programme implemented based on student feedback and design.",
        metrics: [
  ...
  const getImpactBadgeColor = (impact): void => {
    switch (impact) {
      case "High":
  ...
  const formatBeforeAfterData = (metrics): void => {
