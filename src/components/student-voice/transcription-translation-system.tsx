...
export default function TranscriptionTranslationSystem() {
  ...
  const transcribeAudio = (audioBlob: Blob) => {
    ...
    setTimeout(() => {
      ...
      const mockTranscriptions = [
        ...
        "Let's review what we learnt yesterday about the structure of plant cells.",
  ...
  const toggleLiveTranscription = (): void => {
                  ...
                  {vocabularyForm.translations.map((translation, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      ...
                      <Input
                        ...
                        onChange={(e: any) => handleTranslationChange(index, 'translation', e.target.value)}
                        className="flex-1"
                        disabled={isLoading}
                      />
