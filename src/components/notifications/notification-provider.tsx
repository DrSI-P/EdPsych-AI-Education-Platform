 ...
 */
const NotificationToast = ({ notification, onClose }): void => {
  ...
  const getNotificationIcon = (type): void => {
    switch (type) {
      case 'assignment':
 ...
 */
const NotificationProvider = ({ children }): void => {
  const [notifications, setNotifications] = useState([]);
  
  // Add a new notification
  const addNotification = (notification): void => {
