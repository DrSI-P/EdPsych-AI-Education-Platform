...
const ParentPortal = (): void => {
  ...
  const [childProgress, setChildProgress] = useState({
    ...
    subjects: [
      { name: 'Mathematics', progress: 75, mark: 'B+', strengths: ['Problem solving', 'Number operations'], areas_for_improvement: ['Fractions', 'Word problems'] },
      { name: 'English', progress: 68, mark: 'B', strengths: ['Reading comprehension', 'Vocabulary'], areas_for_improvement: ['Writing structure', 'Grammar'] },
      { name: 'Science', progress: 82, mark: 'A-', strengths: ['Scientific inquiry', 'Plant biology'], areas_for_improvement: ['Data recording'] },
      { name: 'Social Studies', progress: 60, mark: 'C+', strengths: ['Historical knowledge'], areas_for_improvement: ['Geography', 'Current events'] }
    ],
    recentActivities: [
  ...
  const markNotificationAsRead = (notificationId): void => {
  ...
  const sendMessage = (recipient, subject, message): void => {
    const newMessage = {
  ...
  const submitSupportRequest = (topic, description): void => {
    const newRequest = {
      ...
      <div className="p-6">
        ...
        {activeTab === 'overview' && (
          <div>
            ...
            {/* Behavior Notes */}
            <div className="mb-6">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Behavior Notes</h3>
              <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className={`px-2 py-1 text-xs rounded-full ${
                          subject.mark.startsWith('A') 
                            ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300'
                            : subject.mark.startsWith('B')
            ...
            <div>
              ...
              <div className="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-gray-700 rounded-md p-4">
                ...
                <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 mb-4">
                  ...
                  <li>Create mind maps for organising information</li>
                </ul>
