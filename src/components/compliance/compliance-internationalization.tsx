 ...
 */
const ComplianceInternationalization = (): void => {
  ...
  const runComplianceAudit = (complianceType): void => {
  ...
  const viewComplianceDetails = (complianceType): void => {
  ...
  const manageLanguage = (languageCode): void => {
