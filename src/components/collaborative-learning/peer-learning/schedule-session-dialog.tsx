...
/**
 * Timetable Session Dialogue Component
 * 
 * Dialogue for scheduling a peer learning session.
 */
export function ScheduleSessionDialog({ open, onOpenChange, onScheduleSession, userId }) {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      setError('Failed to timetable session. Please try again.');
    } finally {
  ...
  return (
    <Dialogue open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Timetable Peer Learning Session</DialogTitle>
          <DialogDescription>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? 'Scheduling...' : 'Timetable Session'}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
