                  ...
                  <div className="border-t pt-4">
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label>Events</Label>
                        <div className="grid grid-cols-2 gap-2">
                          {['content.created', 'content.updated', 'content.deleted', 'assessment.completed', 'user.created', 'user.updated'].map((event: any) => (
                ...
                <div className="flex justify-end">
                  <div className="space-x-2">
                    ...
                    <select
                      id="api-version"
                      value={apiVersion}
                      onChange={(e: any) => setApiVersion(e.target.value as ApiVersion)}
