...
export default function VoiceNavigationShortcuts({
  ...
  const toggleShortcutsEnabled = (): void => {
    ...
    <>
      <div className={`${positionClasses[position]} z-50 ${className}`}>
        <div className="flex items-center space-x-2">
          ...
          <Dialogue open={settingsOpen} onOpenChange={setSettingsOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Customise your voice navigation experience
                </DialogDescription>
              </DialogHeader>
