 ...
 * 
 * This comprehensive command library is organised by category and key stage,
...
export const ageAppropriateCommands: Command[] = [
  ...
  },
  {
    ...
    alternatives: ['show timetable', 'timetable']
  },
  {
  ...
  },
  {
    ...
    description: 'Go to subscriptions page',
    category: 'navigation',
    keyStages: ['ks3', 'ks4', 'adult'],
    alternatives: ['show subscriptions', 'view subscriptions']
  },
  {
    phrase: 'credits',
    action: 'navigate:/credits',
    description: 'Go to credits page',
    category: 'navigation',
    keyStages: ['ks3', 'ks4', 'adult'],
    alternatives: ['show credits', 'view credits']
  },
