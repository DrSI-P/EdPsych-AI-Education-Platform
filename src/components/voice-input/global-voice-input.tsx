...
import { Dialogue, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/dialog';
              ...
              <Card className="w-80 shadow-lg">
                ...
                <CardContent className="p-3 space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Dialogue open={showSettings} onOpenChange={setShowSettings}>
