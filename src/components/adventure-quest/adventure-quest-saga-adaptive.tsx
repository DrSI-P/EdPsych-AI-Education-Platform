...
export const AdventureQuestSagaAdaptive = (): JSX.Element => {
    ...
    return {
      ...
      challenges: [
        ...
        },
        {
          ...
          content: `Use what you've learnt about ${params.subject} to complete this challenge`,
          type: 'interactive',
          minScore: 70
        }
      ]
  ...
  const handleCompleteQuest = (quest: Quest, results: unknown): void => {
  ...
  const handleParamChange = (param: string, value: unknown): void => {
    setGenerationParams({
      ...generationParams,
      [param]: value
    });
      ...
      <div className="adventure-quest-character-creation">
        <Card className="w-full max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Customise your character to begin your learning adventure
            </CardDescription>
          </CardHeader>
          <CardContent>
