...
const DeploymentDevOps = (): void => {
  ...
  const triggerPipeline = (pipelineId): void => {
  ...
  const viewPipelineLogs = (pipelineId): void => {
  ...
  const viewEnvironmentDetails = (envId): void => {
  ...
  const viewReleaseNotes = (releaseId): void => {
