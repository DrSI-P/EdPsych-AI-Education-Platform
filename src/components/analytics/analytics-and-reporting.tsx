            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between rounded-md bg-muted p-3">
                <div className="flex items-center space-x-3">
                  <TrendingUp className="h-5 w-5 text-blue-500" />
                  <div>
                    <p className="text-sm font-medium">Behavior Management</p>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2 pt-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="terms-all-behavior" />
                  <label
                    htmlFor="terms-all-behavior"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  >
                    All Behavior Data
                  </label>
            ...
            <div className="pt-4 space-y-2">
              <Label htmlFor="timetable-export">Timetable Regular Export</Label>
              <Select defaultValue="none">
                <SelectTrigger id="timetable-export">
                  <SelectValue placeholder="Select timetable" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">No Timetable (One-time)</SelectItem>
                  <SelectItem value="weekly">Weekly</SelectItem>
                  <SelectItem value="monthly">Monthly</SelectItem>
                  <SelectItem value="termly">Termly</SelectItem>
                </SelectContent>
