...
const mockModuleIntegrations = [
  { 
    ...
    metrics: [
      ...
      { name: 'Behavior Incidents', status: 'Active' },
...
const AnalyticsIntegration = (): void => {
  ...
  const handleModuleSelect = (moduleId): void => {
    setSelectedModule(moduleId);
  };

  const handleExport = (format): void => {
    toast({
  ...
  const handleToggleSetting = (settingId, currentValue): void => {
