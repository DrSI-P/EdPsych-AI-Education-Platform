 ...
 * Provides interface for creating, organising, and managing educational content
 */
const ContentManagementSystem = (): void => {
  ...
  const toggleItemSelection = (itemId): void => {
  ...
  const navigateToFolder = (folderId, folderName): void => {
  ...
  // Format file size
  const formatFileSize = (size): void => {
    if (size === null) return '';
  ...
  const getContentIcon = (type): void => {
    switch (type) {
      case 'folder':
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Create, organise, and manage your educational content
            </p>
          </div>
