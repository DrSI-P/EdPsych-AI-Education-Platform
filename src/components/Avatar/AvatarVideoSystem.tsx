...
const avatarScripts: Record<string, AvatarVideoScript> = {
  'welcome-intro': {
    ...
    // Fix: Use placeholder image instead of missing video
  ...
  return (
    <Card className={`overflow-hidden ${className}`}>
      ...
      <CardContent className="space-y-4">
        {/* Video Player - Replaced with placeholder since videos are missing */}
        <div className="relative aspect-video bg-gray-900 rounded-lg overflow-hidden">
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-800 text-white p-6">
            ...
            <p className="text-center text-gray-300 mb-4">{script.description}</p>
            <div className="max-w-md text-sm text-gray-400 text-center italic">
        ...
        {/* Audio Player section removed since audio files are missing */}
