...
export const VideoGenerator: React.FC<VideoGeneratorProps> = ({
  ...
  const getAvailableEmotions = (): void => {
  ...
  const getAvailableSpeakingStyles = (): void => {
    const selectedAvatar = avatarModels.find(model => model.id === selectedAvatarId);
  ...
  const getAvailableBackgroundTypes = (): void => {
    const selectedAvatar = avatarModels.find(model => model.id === selectedAvatarId);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e: any) => setShowCaptions(e.target.checked)}
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      id="visualAids"
                      checked={visualAids}
                      onChange={(e: any) => setVisualAids(e.target.checked)}
                      className="h-4 w-4 rounded border-gray-300"
                    />
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e: any) => setSpeedMultiplier(parseFloat(e.target.value))}
                      className="w-full"
                    />
              ...
              {generatedVideo ? (
                ...
                <div className="flex flex-col items-center justify-center p-12">
                  ...
                  <p className="text-muted-foreground text-center mb-6">
                    Please wait whilst we generate your avatar video. This may take a few minutes.
                  </p>
