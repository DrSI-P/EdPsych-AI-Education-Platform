...
export function CurriculumContentLocalization() {
  ...
  const culturalContextNotes = {
    ...
    "pl": "Polish educational system uses different mark structures and assessment methods. Some mathematical notations may differ from UK standards."
  };
  
  // Get cultural context for current language
  const getCurrentCulturalContext = (): void => {
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {t('terminology_note_desc', TranslationNamespace.CURRICULUM, { default: 'UK curriculum terminology is preserved to maintain educational consistency whilst providing translations for understanding.' })}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1 text-sm list-disc pl-5">
                      <li>
                        {t('grading_systems', TranslationNamespace.CURRICULUM, { default: 'Different marking systems and assessment methods' })}
                      </li>
                      <li>
                  ...
                  <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-md p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          {t('cultural_sensitivity_desc', TranslationNamespace.CURRICULUM, { default: 'All curriculum content is adapted with cultural sensitivity whilst maintaining educational objectives.' })}
                        </p>
                      </div>
                    </div>
                  </div>
