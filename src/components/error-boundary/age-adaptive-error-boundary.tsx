      ...
      <CardContent className="pt-4">
        <div className="mb-4 p-3 bg-red-50 border border-red-100 rounded-md">
          ...
          <p className="text-red-700 text-sm">
            An unexpected error occurred whilst rendering this component. The application has recovered, but the requested content could not be displayed.
          </p>
        </div>
