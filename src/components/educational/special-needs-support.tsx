 ...
 */
const SpecialNeedsSupport = (): void => {
      ...
      try {
        ...
        const mockTools = [
          ...
          },
          {
            ...
            category: 'sensory',
            description: 'Evaluate sensory processing patterns and create personalized sensory diets',
            targetAges: '4-18',
            usageCount: 178,
          ...
          {
            id: '5',
            name: 'Behavior Tracking System',
            category: 'behavior',
            description: 'Record, analyze, and identify patterns in behavior for targeted support',
            targetAges: '4-18',
            usageCount: 289,
        ...
        const mockInterventions = [
          ...
          },
          {
            ...
            category: 'executive-function',
            description: 'One-to-one coaching to develop planning, organization, and time management skills',
  ...
  const getCategoryBadge = (category): void => {
    const categories = {
      ...
      'behavior': { bg: 'bg-red-100 dark:bg-red-900', text: 'text-red-800 dark:text-red-300', label: 'Behavior' },
        ...
        <div className="p-6">
          <div className="mb-6 flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div className="flex flex-wrap gap-2">
              {['literacy', 'executive-function', 'social-emotional', 'sensory', 'behavior', 'wellbeing'].map(category => (
                <button 
                  key={category}
