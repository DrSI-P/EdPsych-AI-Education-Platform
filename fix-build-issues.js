...
console.log('npx prisma migrate resolve --applied 20250521040000_add_curriculum_collaboration_models && npx prisma migrate deploy && npm run build');
console.log('Note: The migrations 20250521020000_add_password_reset_model and 20250521030000_add_password_field_to_user are already marked as applied in the database, so we don\'t need to resolve them again.');
