# Administrator Guide for EdPsych-AI-Education-Platform
...
- Use a strong, unique password (minimum 12 characters with a mix of letters, numbers, and symbols)
...
1. Navigate to **Security > GDPR Tools**
2. Manage:
